...
translate languagetwo amos_intro_8dd1a6f1:
    ...
    "Sentando-se no bar, você espera pelo barman."
...
translate languagetwo amos_intro_83dcbc66:
    ...
    "Perguntas e dúvidas se agitam em seu estômago, mas você percebe que este é um passo importante que está dando em sua nova vida."
...
translate languagetwo amos_intro_a3ccf73e:
    ...
    "Deve ser exatamente como da última vez — sentar, olhar em volta e esperar que um cara super gostoso se aproxime de você."
...
translate languagetwo amos_intro_2c2d9074:
    ...
    "Deixar que ele pague uma bebida, ofereça o número dele e você seguirá seu caminho feliz."
...
translate languagetwo amos_intro_cabcb91c:
    ...
    "Ele olha para você por um segundo antes de servir uma bem gelada."
...
translate languagetwo amos_intro_ad9aa952:
    ...
    "Você toma um gole da bebida, começa a olhar em volta, quando um cara desliza para o seu lado. O rosto dele é todo sorrisos e olhares brilhantes."
...
translate languagetwo amos_intro_a82a65f2:
    ...
    "Ele examina seu corpo, devagar e pensativo, como se estivesse imaginando coisas."
...
translate languagetwo amos_intro_e24e4ecc:
    ...
    rico_off "Eu sou o Rico. Eu {i}não{/i} sou espanhol. Mas eu {i}sou{/i} Rico. Quem é você?"

# game/script_amos.rpy:38
translate languagetwo amos_intro_32a35ce4:

    # mside "I'm [m]. Nice to meet you."
    mside "Eu sou o [m]. Prazer em te conhecer."
...
translate languagetwo amos_intro_528a2f76:
    ...
    rico_off "Poderia ser mais do que um prazer. Deixe-me pagar outra bebida para você."

# game/script_amos.rpy:41
translate languagetwo amos_intro_43797bd6:

    # mside "But, er, I just started this one."
    mside "Mas, er, eu acabei de começar esta."
...
translate languagetwo amos_intro_b65aaa22:
    ...
    rico_off "Pense no álcool como um lubrificante. Quanto mais você usa, mais fácil fica. Certo?"
...
translate languagetwo amos_intro_e7a327fc:
    ...
    rico_off "As bebidas, elas libertam seu verdadeiro eu. Tornam mais fácil fazer amizade. Assim como o lubrificante."
...
translate languagetwo amos_intro_1e2fd48b:
    ...
    rico_off "Desculpe, mas você está se fazendo de difícil? Isso é incrivelmente fofo."

# game/script_amos.rpy:61
translate languagetwo amos_intro_b07025d3:

    # mside "Ok, I'm not playing hard-to-get."
    mside "Ok, eu não estou me fazendo de difícil."
...
translate languagetwo amos_intro_ab91d0ae:
    ...
    rico_off "Você gosta da perseguição, estou vendo. Eu posso fazer isso. Na verdade, sou {i}muito{/i} bom nisso."
...
translate languagetwo amos_intro_e58109ed:
    ...
    rico_off "Ok, entendi. Você quer ir com calma. Eu entendo. Vou te dar um tempo para pensar. Não é problema."

# game/script_amos.rpy:78
translate languagetwo amos_intro_b0992ac3:

    # "Rico leaves. You exhale."
    "Rico vai embora. Você expira aliviado."
...
translate languagetwo amos_intro_777ed53f:
    ...
    "Virando-se para o homem mais velho sentado ao seu lado, você nota uma expressão de diversão no rosto dele."

# game/script_amos.rpy:83
translate languagetwo amos_intro_d61927c6:

    # mside "What was up with him?"
    mside "Qual era a dele?"
...
translate languagetwo amos_intro_ae6e5c33:
    ...
    conrad_off "Aquele é o Rico. Ele não é espanhol. Mas ele {i}é{/i} Rico. Essa é a cantada padrão dele. Parece funcionar metade das vezes."
...
translate languagetwo amos_intro_48f58822:
    ...
    "Você sorri. O cavalheiro com quem você está falando tem um rosto agradável, caloroso e um ar relaxado."
...
translate languagetwo amos_intro_45706d09:
    ...
    conrad_off "Nunca te vi aqui antes. Tirando o Rico, o que você está achando?"
...
translate languagetwo amos_intro_689362d4:
    ...
    mside "Tem sido uma noite difícil. Mas talvez esteja prestes a melhorar?"
...
translate languagetwo amos_intro_4c71ca6b:
    ...
    conrad_off "Já que você é obviamente novo nisso, deixe-me te dar algumas dicas. Existem dois tipos de caras aqui — caras como o Rico, e caras como eu."
...
translate languagetwo amos_intro_b58cc706:
    ...
    conrad_off "Se você procura algo rápido ou fácil, encontre um babaca simpático. Como o Rico. Outros, como eu, estão aqui para curtir, deixar a vida acontecer. Sem pressão ou fingimento."
...
translate languagetwo amos_intro_ee147647:
    ...
    conrad_off "Eu acredito que você precisa estar aberto a {i}todas{/i} as possibilidades que a vida tem a oferecer."
...
translate languagetwo amos_intro_893913c6:
    ...
    mside "Pois é, né? Não aja como se fosse a única pessoa que importa."
...
translate languagetwo amos_intro_9160bca6:
    ...
    conrad_off "Exatamente. Quando duas pessoas se encontram, há duas personalidades, dois conjuntos de desejos, dois conjuntos diferentes de experiências e expectativas."

# game/script_amos.rpy:105
translate languagetwo amos_intro_87def0d9:

    # mside "That guy was acting like I wasn't even a person."
    mside "Aquele cara estava agindo como se eu nem fosse uma pessoa."
...
translate languagetwo amos_intro_5bf55014:
    ...
    conrad_off "Mesmo que essas duas pessoas compartilhem o mesmo objetivo, não há necessidade de ser insistente ou arrogante sobre isso."
...
translate languagetwo amos_intro_2c0b0684:
    ...
    mside "Certo. Obrigado por dizer isso. Sabe, estou feliz por ter ficado esta noite."
...
translate languagetwo amos_intro_4474e7d6:
    ...
    conrad_off "Fico feliz em poder ajudar. Só quero que você se sinta confortável. Posso pedir para encherem sua bebida?"
...
translate languagetwo amos_intro_06a4b268:
    ...
    conrad_off "Na verdade, eu conheço muitos caras aqui e, bem, infelizmente, a maioria deles é muito parecida com o Rico."
...
translate languagetwo amos_intro_97e547fd:
    ...
    conrad_off "Desculpe, apenas má sorte, de certa forma. Nunca se sabe que tipo de público vai aparecer."

# game/script_amos.rpy:116
translate languagetwo amos_intro_badb1bbf:

    # mside "Well, we're having a nice conversation, right?"
    mside "Bem, estamos tendo uma conversa agradável, certo?"
...
translate languagetwo amos_intro_b69bd093:
    ...
    conrad_off "Sim, com certeza. Eu gostaria que isso continuasse. Quer saber? Por que não saímos daqui? Tenho um quarto aqui perto. Para fugir de todos os, você sabe, Ricos."
...
translate languagetwo amos_intro_7bf768ae:
    ...
    conrad_off "Sim, é agradável e silencioso. Podemos conversar."
...
translate languagetwo amos_intro_2cfbfbce:
    ...
    "O rosto dele parece suplicante e sincero, mas o corpo está tenso, como um animal esperando para atacar."

# game/script_amos.rpy:125
translate languagetwo amos_intro_babcaba1:

    # conrad_off "Whatever do you mean? I {i}am{/i} a nice guy."
    conrad_off "O que você quer dizer? Eu {i}sou{/i} um cara legal."
...
translate languagetwo amos_intro_0453e1f4:
    ...
    mside "Você tentou me levar para sua casa dois minutos depois de me conhecer. Sério, você está brincando? Depois daquele discurso dramático sobre dois tipos de caras?"
...
translate languagetwo amos_intro_25966e27:
    ...
    "Você olha para baixo. Dito e feito, há uma mão na sua coxa, fazendo uma massagenzinha."

# game/script_amos.rpy:149
translate languagetwo amos_intro_251e0467:

    # mside "WHAT THE HELL!?"
    mside "MAS QUE DIABOS!?"
...
translate languagetwo amos_intro_f3d39fe9:
    ...
    "Você pula da banqueta. Um senhor alto, magro e mais velho, com um bigode fino, te come com os olhos."
...
translate languagetwo amos_intro_d7229229:
    ...
    "Você sente uma raiva crescendo em alguma parte vestigial do seu corpo."

# game/script_amos.rpy:156
translate languagetwo amos_intro_23affab8:

    # mside "I'm not interested."
    mside "Não estou interessado."
...
translate languagetwo amos_intro_0107e529:
    ...
    mside "Ah é? Bem, eu não estou jogando golfe, estou? Então por que eu me importaria com estar à altura?"
...
translate languagetwo amos_entrance_bb4b995f:
    ...
    "Uma voz emerge do final do bar. Alta, lenta, inabalável."
...
translate languagetwo amos_entrance_495ccde4:
    ...
    amside_off_poetry "Eu não discuto — inclino minha cabeça para perto, e meio que a envolvo, sento-me quieto ao lado — permaneço fiel,"
...
translate languagetwo amos_entrance_cf4a8cd1:
    ...
    amside_off_poetry "Sou mais que enfermeiro, mais que pai ou vizinho, absolvo-te de tudo exceto de ti mesmo, espiritual, corporal — isso é eterno,"
...
translate languagetwo amos_entrance_6787a61b:
    ...
    amside_off_poetry "O cadáver que deixarás não será senão excrementício."
...
translate languagetwo amos_entrance_10e93e39:
    ...
    "O esquisitão não diz nada enquanto vai embora. Você não tem certeza do que acabou de acontecer, mas fica feliz em vê-lo partir."
...
translate languagetwo amos_entrance_16e0233b:
    ...
    "O homem mal consegue conter o riso. Sua risada rouca e livre preenche o bar e deixa o ar mais leve."
...
translate languagetwo amos_entrance_3b055f17:
    ...
    amos "Desculpe. Oh nossa. Não. Eu sou o Amos. Meu deus. Essa foi demais."
...
translate languagetwo amos_entrance_b8a3e1d9:
    ...
    amos "Walt Whitman é o autor da poesia que acabei de recitar, jovem."
...
translate languagetwo amos_entrance_de0d9a40:
    ...
    amos "Aquele cara na verdade não deveria estar aqui. Ele já foi expulso muitas vezes por fazer coisas assim."
...
translate languagetwo amos_entrance_5fe79935:
    ...
    mside "Bem, que bom que você estava aqui. Armado com suas, uh, habilidades de citação de poesia."
...
translate languagetwo amos_entrance_03447b14:
    ...
    amos "É, acho que isso o pegou desprevenido. As pessoas não esperam o lado intelectual de um homem de aparência tão comum como eu."

# game/script_amos.rpy:222
translate languagetwo amos_entrance_c755d722:

    # "Except this man is anything but plain."
    "Exceto que este homem é tudo, menos comum."
...
translate languagetwo amos_entrance_e159e91b:
    ...
    "A vasta extensão de seu peito, seus braços, mandíbula, bochecha, cabeça e tudo mais forte, largo, absoluto."
...
translate languagetwo amos_entrance_22c598f5:
    ...
    "Você imagina ele socando um prédio e o prédio desmoronando."
...
translate languagetwo amos_entrance_9e0c3d86:
    ...
    amos "Muito obrigado. Esse é um elogio bem interessante. Pelo menos, espero que tenha sido um elogio."
...
translate languagetwo amos_entrance_a70d60d2:
    ...
    mside "Suponho que sim. Talvez eu não devesse ter descontado em você. Desculpe. Deixe-me retirar o que disse."

# game/script_amos.rpy:252
translate languagetwo amos_entrance_88be531b:

    # amos "Thank you for that."
    amos "Obrigado por isso."
...
translate languagetwo amos_entrance_1c6b2192:
    ...
    amos "Deixe-me pedir desculpas por permitir que meus pelos faciais crescessem além do seu limite aceitável."
...
translate languagetwo amos_entrance_c7e88501:
    ...
    mside "Obrigado. Muito obrigado. Isso significa muito, na verdade. Todas essas barbas são como uma epidemia."
...
translate languagetwo amos_entrance_0b5fa6df:
    ...
    amos "De qualquer forma, acho que minha aparência me dá uma vantagem. As pessoas esperam menos de mim porque sou tão, eu acho, grande. É mais fácil impressionar assim."
...
translate languagetwo amos_entrance_1848f12b:
    ...
    mside "Hã. {i}A maior limitação do homem não é seu corpo ou sua mente, mas sua própria opinião sobre si mesmo.{/i}"
...
translate languagetwo amos_entrance_e70ac7ba:
    ...
    mside "Ah, eu estava citando algo que um amigo me disse mais cedo."
...
translate languagetwo amos_entrance_81f09093:
    ...
    amos "Seu amigo é sábio. De fato, somos mais prisioneiros das mentiras que aceitamos sobre nós mesmos do que qualquer outra coisa."

# game/script_amos.rpy:283
translate languagetwo amos_entrance_2e7e523a:

    # mside "I'm [m], by the way."
    mside "Eu sou o [m], a propósito."
...
translate languagetwo amos_entrance_b36741a5:
    ...
    amos "Prazer em te conhecer, [m]. Eu me ofereceria para pagar outra bebida, mas tenho que ir. Posso, no entanto, te dar uma carona se precisar."
...
translate languagetwo amos_entrance_4cdedc75:
    ...
    amos "Muito bem. Foi bom te conhecer. Talvez eu te veja por aí no futuro."
...
translate languagetwo amos_entrance_c7b5716a:
    ...
    "Você termina sua bebida e decide que já teve o suficiente."

# game/script_amos.rpy:300
translate languagetwo amos_entrance_36b6c684:

    # "You call Penny for a ride."
    "Você liga para a Penny pedindo uma carona."
...
translate languagetwo amos_entrance_090a2adc:
    ...
    amos "Não é truque nenhum. Tudo o que quero dizer quando digo que estou oferecendo uma carona, é que estou oferecendo uma carona."

# game/script_amos.rpy:308
translate languagetwo amos_entrance_3afeb438:

    # mside "Ok. A ride would be great."
    mside "Ok. Uma carona seria ótima."
...
translate languagetwo amos_motorcycle_ride_81726252:
    ...
    "Lá fora, Amos te equipa com o capacete dele, que fica chacoalhando na sua cabeça."
...
translate languagetwo amos_motorcycle_ride_b003b417:
    ...
    "Vocês dois disparam na moto dele, a moto tão grande e potente quanto o homem pilotando."
...
translate languagetwo amos_motorcycle_ride_19d19b50:
    ...
    "Você se segura firme enquanto o motor rugindo e a força repentina da aceleração emocionam seu corpo e mente."
...
translate languagetwo amos_motorcycle_ride_7fe0db66:
    ...
    "Por um momento, você imagina envolver seus braços em volta dele, descansando sua bochecha nas costas dele. O vento em seu rosto, o perigo do passeio em seu coração."
...
translate languagetwo amos_motorcycle_ride_81726407:
    ...
    "Na lateral da moto dele tem uma pequena cesta de vime."
...
translate languagetwo amos_motorcycle_ride_bb7d4bdc:
    ...
    "Enquanto a moto desacelera um pouco, você grita sobre o barulho do motor."

# game/script_amos.rpy:330
translate languagetwo amos_motorcycle_ride_dd4c89f1:

    # mside "What's that?"
    mside "O que é aquilo?"
...
translate languagetwo amos_motorcycle_ride_43b8e7b3:
    ...
    amside "A cesta é para minha cachorra, Dulcie. Você tem que conhecê-la. Mas já vou avisando, ela é uma conquistadora."

# game/script_amos.rpy:334
translate languagetwo amos_motorcycle_ride_9eaa6ae0:

    # mside "Oh, cool. What kind of dog?"
    mside "Ah, legal. Que tipo de cachorro?"
...
translate languagetwo amos_motorcycle_ride_41dff061:
    ...
    amside "Acho que você pegou o jeito!"
...
translate languagetwo amos_motorcycle_ride_ec7fd641:
    ...
    "Parece que a emoção do passeio intoxicou seus sentidos, encheu você com uma sensação de aventura e libertou seu lado bobo."
...
translate languagetwo amos_motorcycle_ride_38f0b0fd:
    ...
    amside "Gostaria de fazer algo algum dia — algo, ouso dizer, romântico?"
...
translate languagetwo amos_motorcycle_ride_513dce67:
    ...
    "Se você decidir sair com Amos no domingo, não terá tempo extra neste fim de semana para estudar, dar aulas particulares ou outras atividades sociais com seus colegas de quarto."

# game/script_amos.rpy:379
translate languagetwo amos_motorcycle_ride_684fc094:

    # amside "We'll see, I suppose."
    amside "Veremos, eu suponho."
...
translate languagetwo amos_motorcycle_ride_e9817528:
    ...
    amside "A normalidade é o refúgio dos sem imaginação. Vou manter minha oferta de um encontro romântico."
...
translate languagetwo amos_motorcycle_ride_6b795b90:
    ...
    mside "Tudo bem, se tem que ser assim, então eu suponho que 'sim'."
...
translate languagetwo amos_motorcycle_ride_de129ddc:
    ...
    amside "Isso parece muito divertido, mas na verdade sou alérgico a moedas de um centavo."

# game/script_amos.rpy:395
translate languagetwo amos_motorcycle_ride_9cda337e:

    # mside "That's terrible."
    mside "Isso é terrível."
...
translate languagetwo amos_motorcycle_ride_edd276fa:
    ...
    amside "É, e isso me causou uma quantidade incalculável de problemas."
...
translate languagetwo amos_motorcycle_ride_059ff577:
    ...
    "Você chega ao seu apartamento e agradece a Amos pela carona."
...
translate languagetwo amos_motorcycle_ride_c54a02a9:
    ...
    "Você ouve o ronco do motor à distância enquanto ele vai embora."
...
translate languagetwo amos_motorcycle_ride_129adbec:
    ...
    amside "Então é um encontro. Vejo você em breve."
...
translate languagetwo amos_motorcycle_ride_3927b2af:
    ...
    "Você chega ao seu apartamento, cativado pela quietude da noite, seu coração acelerado, a postura calma de Amos. Você se maravilha com o rosto dele."
...
translate languagetwo amos_motorcycle_ride_165e4e3b:
    ...
    "Depois de trocarem contatos, Amos coloca o capacete e vai embora, o ronco do motor obliterando o silêncio noturno."
...
translate languagetwo amos_apartment_talk_da03d107:
    ...
    "Você vai para a cozinha para requentar um resto de macarrão com queijo. Você pega uma lata gelada de cola genérica para acompanhar."
...
translate languagetwo amos_apartment_talk_eb905e72:
    ...
    mside "Bem. Eu não sei. Nada realmente aconteceu."
...
translate languagetwo amos_apartment_talk_e8a753f6:
    ...
    p "Você está mentindo totalmente. Dá para notar. Você não está com aquele brilho pós-pênis, mas algo definitivamente aconteceu."
...
translate languagetwo amos_apartment_talk_e63df36f:
    ...
    mside "Jesus Cristo, Penny! Como é exatamente esse 'brilho pós-pênis'?"
...
translate languagetwo amos_apartment_talk_f5aa0bed:
    ...
    p "Oooohhh, um nome bíblico. Assim como você, [m]! É obviamente o destino."
...
translate languagetwo amos_apartment_talk_365fbea8:
    ...
    p "Me conte tudo sobre ele. Estatísticas, frases, o pacote completo."
...
translate languagetwo amos_apartment_talk_e93db629:
    ...
    p "Ele é marombado no máximo? Carne crua desfiada? Bombado como o Papai Noel? Puro suco do diesel de macho?"
...
translate languagetwo amos_apartment_talk_954a6e40:
    ...
    lb "Ian, como exatamente você conseguiu que o conselho de admissões te deixasse entrar nesta faculdade?"
...
translate languagetwo amos_apartment_talk_71adfdef:
    ...
    ian "Gosto de pensar que não foi apenas meu histórico acadêmico quase excelente, mas todo o potencial bruto e inexplorado que trago para a mesa."
...
translate languagetwo amos_apartment_talk_eaad06ec:
    ...
    ian "Além do meu charme e dotes físicos óbvios, as pessoas acham fácil se identificar comigo e sentem que coisas boas acontecerão sempre que estou por perto."

# game/script_amos.rpy:517
translate languagetwo amos_apartment_talk_f7efe1eb:

    # ian "You see, I'm not just—"
    ian "Veja bem, eu não sou apenas—"

# game/script_amos.rpy:519
translate languagetwo amos_apartment_talk_eb2ac949:

    # lb "IAN, ENOUGH. [m], please continue."
    lb "IAN, CHEGA. [m], por favor, continue."
...
translate languagetwo amos_apartment_talk_ded73025:
    ...
    ian "É, vamos ouvir mais sobre esse cara, cara. Então, o que aconteceu depois que eu fui embora ontem à noite?"

# game/script_amos.rpy:523
translate languagetwo amos_apartment_talk_0d5c108d:

    # mside "Well, this creep was waving money at me—"
    mside "Bem, tinha um esquisitão balançando dinheiro na minha cara—"
...
translate languagetwo amos_apartment_talk_24b0129d:
    ...
    mside "Eu não sei. Mas o Amos começou a recitar versos desse poema. E o outro cara ficou intimidado e simplesmente foi embora."
...
translate languagetwo amos_apartment_talk_53117639:
    ...
    mside "Então ficamos conversando um pouco antes de ele ter que ir. Aí ele me deu uma carona para casa na moto dele."
...
translate languagetwo amos_apartment_talk_6cef31b7:
    ...
    lb "Isso parece bem fofo. Você vai vê-lo de novo?"
...
translate languagetwo amos_apartment_talk_f5536adb:
    ...
    mside "Sim. Ele está organizando algo. Disse que seria romântico."
...
translate languagetwo amos_apartment_talk_6eedea9a:
    ...
    ian "Parece um mulherengo pra mim. Esses caras com suas motos e caixas de bombom geralmente são problema, [m]."
...
translate languagetwo amos_meet_3_a9b5e9f3:
    ...
    "Você ouve o ronco da moto lá fora, anunciando a chegada do seu pretendente."
...
translate languagetwo amos_meet_3_6dd3a264:
    ...
    "Você se examina no espelho. Cabelo no lugar — confere, sorriso vencedor — confere, sem meleca no nariz — confere."

# game/script_amos.rpy:565
translate languagetwo amos_meet_3_7fff245d:

    # mside "Lookin' good, [m]. Lookin' {i}real{/i} good."
    mside "Tá bonito, [m]. Tá {i}muito{/i} bonito."
...
translate languagetwo amos_meet_3_f318b158:
    ...
    "Você anda nervosamente, checando-se no espelho pelo menos uma dúzia de vezes."

# game/script_amos.rpy:570
translate languagetwo amos_meet_3_7f92057d:

    # "Amos knocks and you open the door."
    "Amos bate e você abre a porta."
...
translate languagetwo amos_meet_3_910e6a83:
    ...
    "Usando sapatos sociais, calças plissadas e uma camisa branca de colarinho sob um suéter amarelo claro com gola V, ele está muito mais bem vestido que você."
...
translate languagetwo amos_meet_3_87e8f4b4:
    ...
    amos "É melhor irmos. Dulcie está nos esperando. Ela tem uma ansiedade de separação terrível."
...
translate languagetwo amos_ride_2_c0cf590d:
    ...
    "Vocês dois descem as escadas para a carruagem que o aguarda. Na cesta está o cachorro mais caseiro, mais bagunçado, mas de alguma forma mais fofo que você já viu."
...
translate languagetwo amos_ride_2_0e75cc78:
    ...
    amos "[m], gostaria de apresentá-lo a Dulcinea. Ela é um pouco tímida no começo, então não se ofenda com a falta de modos dela. Ela só gosta de levar o tempo dela com pessoas novas."

# game/script_amos.rpy:616
translate languagetwo amos_ride_2_a95bc2c4:

    # mside "Hi, puppy."
    mside "Oi, cachorrinha."
...
translate languagetwo amos_ride_2_47b289d4:
    ...
    "Dulcie olha para você, indiferente. Você tem a sensação de que ela está julgando suas roupas desfavoravelmente."

# game/script_amos.rpy:625
translate languagetwo amos_ride_2_aeb3a625:

    # "You climb on the back of the bike and grab hold."
    "Você sobe na garupa da moto e se segura."
...
translate languagetwo amos_ride_2_24236ed1:
    ...
    "Vocês descem a rodovia — em direção às colinas, percorrendo um longo e sinuoso trecho de estrada, sem nenhum outro veículo à vista."
...
translate languagetwo amos_ride_2_fe2c9f83:
    ...
    "Vocês chegam a um portão trancado. Além do portão trancado, um prado."
...
translate languagetwo amos_picnic_c0d32c82:
    ...
    "Amos desce, puxa um estranho mecanismo com duas rodas de borracha de um alforje. Ele pega Dulcie da cesta e a prende no dispositivo."

# game/script_amos.rpy:635
translate languagetwo amos_picnic_8f57080e:

    # amside "She's a wheelie dog. Her back legs never worked."
    amside "Ela é uma cachorra de rodinhas. As patas traseiras dela nunca funcionaram."
...
translate languagetwo amos_picnic_f9715523:
    ...
    amside "Não se preocupe, ela se locomove esplendidamente."
...
translate languagetwo amos_picnic_5dec0a09:
    ...
    "Assim que Dulcie está posicionada, ela dispara, rodando, cheirando, examinando o ambiente, em direção ao prado."
...
translate languagetwo amos_picnic_e22b8761:
    ...
    amside "Trouxe a comida padrão. Uma garrafa de vinho, queijo, maçãs, carnes curadas."
...
translate languagetwo amos_picnic_f5c9d45f:
    ...
    amside "Parece que me esqueci desses. Vou lembrar na próxima vez."
...
translate languagetwo amos_picnic_72c683ad:
    ...
    "O prado apresenta uma vista deslumbrante de Orlin abaixo e do vale circundante. Os únicos sons são o canto ocasional de um pássaro e as árvores se movendo com a brisa."
...
translate languagetwo amos_picnic_0a356776:
    ...
    "Você bebe seu vinho e belisca as guloseimas enquanto aprecia a vista e o ar fresco."

# game/script_amos.rpy:699
translate languagetwo amos_picnic_2e51b6b9:

    # amside "This is truly lovely. Thanks for coming."
    amside "Isso é realmente adorável. Obrigado por ter vindo."
...
translate languagetwo amos_picnic_3843e38f:
    ...
    amside "O romantismo é uma arte perdida hoje em dia. Não há apreço pela sutileza, pela construção lenta, pelo intelectualismo envolvido."
...
translate languagetwo amos_picnic_ed42c9fc:
    ...
    amside "Nenhum senso de admiração ou curiosidade genuína sobre a outra pessoa."
...
translate languagetwo amos_picnic_a22fa33c:
    ...
    amside "Parece que todo mundo correu para o fundo do poço. Ser o mais estúpido, superficial e bonito possível e fazer as coisas acontecerem o mais rápido que puder."
...
translate languagetwo amos_picnic_e5cc8b36:
    ...
    amside "Isso me parece mais insegurança do que qualquer outra coisa. Ninguém quer se expor completamente. Enrolado no cobertor aterrorizante, mas maravilhoso, que é se apaixonar."
...
translate languagetwo amos_picnic_ca4f35b4:
    ...
    mside "É, parece que tudo deveria ser divertido e fácil, e se não for, dá muito trabalho."
...
translate languagetwo amos_picnic_eff94bc3:
    ...
    amside "Exatamente, e o custo disso é não desenvolver profundidade real ou confiança ou qualquer coisa verdadeiramente significativa, porque você não se tornou vulnerável."
...
translate languagetwo amos_picnic_23953f89:
    ...
    mside "Talvez seja quase como se o amor tivesse se tornado um tabu? Mas não sei se as pessoas realmente mudaram. É que há muito mais pressão para concordar, para ser legal."
...
translate languagetwo amos_picnic_5a473919:
    ...
    amside "É exatamente isso. Não há nada mais {i}legal{/i} do que apenas 'concordar', não é?"
...
translate languagetwo amos_picnic_461c91d7:
    ...
    amside "Você está prestes a ser abandonado aqui. Escolha suas próximas palavras com cuidado."

# game/script_amos.rpy:738
translate languagetwo amos_picnic_526d6518:

    # mside "Jeez, okay. You actually do make a good point."
    mside "Nossa, tá bom. Você realmente tem um bom ponto."
...
translate languagetwo amos_picnic_3afd2e36:
    ...
    amside "Eu gostaria de poder dizer o mesmo sobre você."
...
translate languagetwo amos_picnic_a126938e:
    ...
    amside "De qualquer forma, você não concorda que é melhor ser diferente {i}e{/i} você mesmo do que a mesma farsa que todo mundo?"

# game/script_amos.rpy:765
translate languagetwo amos_picnic_75094840:

    # mside "Yeah, if you can pull that off."
    mside "Sim, se você conseguir fazer isso."
...
translate languagetwo amos_picnic_133101a4:
    ...
    mside "Digo, você parece ser muito bom nisso. Citando poesia. E uau, tudo isso."
...
translate languagetwo amos_picnic_90dc9774:
    ...
    amside "Eu não sei. Acho que sou um pouco uma relíquia. Isso provavelmente explica meu fascínio por poesia antiga e coisas do tipo."
...
translate languagetwo amos_picnic_6b98770b:
    ...
    mside "Eu acho ótimo. Não apenas o, uh, romantismo, mas o fato de você fazer as coisas do seu jeito."
...
translate languagetwo amos_picnic_95ec9ba5:
    ...
    amside "Não tenho certeza se é {i}minha{/i} coisa, tanto quanto são centenas de anos de tradições e ideias. É realmente algo próximo ao meu coração. Algo que eu realmente aprecio."

# game/script_amos.rpy:775
translate languagetwo amos_picnic_3a8d51df:

    # mside "I think I like that."
    mside "Eu acho que gosto disso."
...
translate languagetwo amos_picnic_d479ded8:
    ...
    "Dulcie está fazendo o melhor que pode para perseguir uma borboleta quando ela quase esbarra em você. Você percebe uma taboa presa na barriga dela."
...
translate languagetwo amos_picnic_95240b00:
    ...
    "Dulcie abana seu rabinho de rato antes de sair correndo."
...
translate languagetwo amos_picnic_99b6df11:
    ...
    "Ela sai correndo, mas para e te lança um olhar como se dissesse 'Eu vou acabar com você um dia, filho da puta'."
...
translate languagetwo amos_picnic_93210b05:
    ...
    mside "Sabe, eu nunca estive em um desses. Parece divertido."
...
translate languagetwo amos_picnic_7cb97789:
    ...
    mside "O balão parece estar vindo para cá. Talvez possamos acenar."
...
translate languagetwo amos_picnic_84830594:
    ...
    amside "Tenho certeza de que quem quer que esteja lá em cima está se divertindo muito e ficaria mais do que feliz em acenar."
...
translate languagetwo amos_picnic_820beac9:
    ...
    mside "É como estar em um barco. Todo mundo está sempre acenando uns para os outros."
...
translate languagetwo amos_picnic_ab5e482d:
    ...
    mside "Parece que eles estão começando a descer. Talvez eles vão dar um rasante na gente."
...
translate languagetwo amos_picnic_a99cbd0a:
    ...
    amside "Talvez eles estivessem planejando pousar aqui e fazer seu próprio piquenique privado. Eles não vão ficar surpresos ao nos ver?"
...
translate languagetwo amos_picnic_bf10f816:
    ...
    mside "Sim, isso seria meio decepcionante. Encontro perfeito planejado com um passeio de balão até o prado, mas já está ocupado."
...
translate languagetwo amos_picnic_6b2bdf17:
    ...
    mside "Sabe, eu não vejo ninguém lá em cima além do balonista."
...
translate languagetwo amos_picnic_8a9fb801:
    ...
    amside "Talvez seja apenas como aquele cara se locomove. Ele é algum bilionário excêntrico que voa com seu balão de ar quente para todo lugar."

# game/script_amos.rpy:831
translate languagetwo amos_picnic_d7d417a6:

    # amside "I imagine parking would be quite a hassle."
    amside "Imagino que estacionar seria um grande incômodo."
...
translate languagetwo amos_picnic_56d2a977:
    ...
    "Amos olhando para o céu para o balão que descia, conduzindo casualmente os eventos do dia como um maestro, se abaixa para arrancar uma folha de grama."
...
translate languagetwo amos_picnic_d8ad381e:
    ...
    amside_poetry "Celebro a mim mesmo, e canto a mim mesmo, e o que eu presumo você presumirá, pois cada átomo pertencente a mim pertence a você."
...
translate languagetwo amos_picnic_ef600031:
    ...
    amside "Então é sorte das formigas que você não trouxe."
...
translate languagetwo amos_picnic_01a90426:
    ...
    mside "Eu nunca olhei por esse lado. Você acha que as formigas falam sobre lupas como uma arma de destruição em massa?"

# game/script_amos.rpy:879
translate languagetwo amos_picnic_06702389:

    # amside "Somehow I doubt it."
    amside "De alguma forma eu duvido."
...
translate languagetwo amos_picnic_3f4f6382:
    ...
    mside "Talvez elas atribuam a combustão espontânea de seus companheiros cidadãos formigas a um ato de Deus."
...
translate languagetwo amos_balloon_ride_9e2224d7:
    ...
    "O balonista pousa e conduz você, Amos e Dulcie para fora. Navegando por cima e além, tudo ao mesmo tempo minúsculo e vasto, sua percepção de si mesmo amplificada."
...
translate languagetwo amos_balloon_ride_2386b1ed:
    ...
    "Amos aponta a casa dele, a floricultura que ele possui, diferentes pontos turísticos, até mesmo seu apartamento. Finalmente, ele se vira para você, gesticulando de volta para o prado."
...
translate languagetwo amos_balloon_ride_892b130b:
    ...
    "Ele olha para você, seus olhos vagando dentro dos seus, procurando pelo pedacinho da sua alma que quer que ele te beije agora."
...
translate languagetwo amos_balloon_ride_a1e66fb5:
    ...
    "Amos se inclina em sua direção, você leva seus lábios aos dele, encontrando-o no meio do caminho. O choque de prazer, seus lábios macios e suaves nos seus, a mão firme em sua cintura."
...
translate languagetwo amos_balloon_ride_84648737:
    ...
    "Você se afasta por um segundo. A respiração dele em suas pálpebras e bochechas, sua mente flutuando, serena e emocionada, você olha para ele."

# game/script_amos.rpy:913
translate languagetwo amos_balloon_ride_834e716d:

    # amside "That was wonderful."
    amside "Isso foi maravilhoso."
...
translate languagetwo amos_balloon_ride_20ec3e3b:
    ...
    "Precisamente então, sentindo que algo está errado, ou talvez apenas para ser uma chata, Dulcie decide soltar seu latido agudo."
...
translate languagetwo amos_balloon_ride_39c2e4d7:
    ...
    "Enquanto ela olha para as vastas distâncias ao redor e abaixo dela, sua expressão muda de preocupação para perplexidade."
...
translate languagetwo amos_balloon_ride_26523592:
    ...
    "Com a língua pendurada no canto da boca, ela parece incapaz de compreender sua posição em relação ao ambiente."
...
translate languagetwo amos_balloon_ride_38c0b91e:
    ...
    "A carinha amassada dela é tão fofa que você quase consegue perdoá-la por interromper o beijo."
...
translate languagetwo amos_balloon_ride_05fee4af:
    ...
    balloonist_off "Eu estava admirando seu trapézio. É coisa de outro mundo. Qual é a sua rotina?"
...
translate languagetwo amos_balloon_ride_dac9a8cb:
    ...
    balloonist_off "Ah é? O que você faz, então? Crossfit?"
...
translate languagetwo amos_balloon_ride_f5f7fdbf:
    ...
    balloonist_off "Nada?! Cara, você deve fazer alguma coisa! Você é enorme!"
...
translate languagetwo amos_balloon_ride_3072356c:
    ...
    amside "Isso é algum tipo de comentário sobre o meu tamanho? Porque se for, não é apreciado."
...
translate languagetwo amos_balloon_ride_8a27046a:
    ...
    balloonist_off "Espera, não fique irritadinho. Foi um elogio. E caramba, não estou tentando dar em cima de você nem nada — especialmente com seu homem aqui e tal."
...
translate languagetwo amos_balloon_ride_ab670a18:
    ...
    "Mas o corpo de Amos — tenso, pronto, parece estranho para você. Ele parece extremamente defensivo."
...
translate languagetwo amos_balloon_ride_c037b553:
    ...
    "Você imagina que ele deve ser sensível sobre seu tamanho. Você faz uma nota mental para não tocar no assunto no futuro."

# game/script_amos.rpy:941
translate languagetwo amos_balloon_ride_6226bf6e:

    # balloonist_off "Okay, whatever you say, man."
    balloonist_off "Ok, o que você disser, cara."
...
translate languagetwo amos_balloon_ride_2eeeadf1:
    ...
    "O piloto olha para o lado como se não fosse ele quem estivesse agindo de forma estranha."

# game/script_amos.rpy:945
translate languagetwo amos_balloon_ride_f64ac7a5:

    # "The mood broken, you try to regather the moment."
    "O clima quebrado, você tenta recuperar o momento."
...
translate languagetwo amos_balloon_ride_9565b385:
    ...
    amside "Aposto que se eu jogasse {i}você{/i} pela borda, eu poderia evitar que coisas estúpidas fossem ditas para mim."

# game/script_amos.rpy:971
translate languagetwo amos_balloon_ride_5e96c7c4:

    # mside "Okay, okay. Jesus. It was just an idea."
    mside "Ok, ok. Jesus. Foi só uma ideia."
...
translate languagetwo amos_balloon_ride_d98bea73:
    ...
    amside "Você está falando de assassinato e roubo qualificado."
...
translate languagetwo amos_balloon_ride_f261ffb8:
    ...
    amside "Ok. Tanto faz. Vou deixar essa passar."
...
translate languagetwo amos_balloon_ride_cdbcb31b:
    ...
    amside "Eu não surtaria, mas me perguntaria por que diabos eu te chamei para sair."
...
translate languagetwo amos_balloon_ride_84998c7d:
    ...
    amside "Espero que isso não soe muito meloso, e pode parecer um pouco cedo, mas vai haver uma leitura de poesia no café na terça-feira. Vou apresentar um poema. Você gostaria de ir?"
...
translate languagetwo amos_balloon_ride_ffdbd232:
    ...
    amside "Adoro fazer isso. Poesia foi feita para ser falada, não lida!"
...
translate languagetwo amos_balloon_ride_3bc39c91:
    ...
    mside "Tipo, não é só um monte de gente sentada lendo. Isso se chama 'biblioteca'. Heh."
...
translate languagetwo amos_balloon_ride_19d7c461:
    ...
    amside "Você tem uma maneira especial de ver as coisas."
...
translate languagetwo amos_balloon_ride_9674dcb3:
    ...
    mside "Acho que não é a minha praia."
...
translate languagetwo amos_balloon_ride_6a9a9586:
    ...
    "Vocês dois se sentam em um silêncio desconfortável pelo resto do passeio."
...
translate languagetwo amos_balloon_ride_52e39c23:
    ...
    "Dulcie começa a se curvar como se fosse cagar."
...
translate languagetwo amos_balloon_ride_4714ccb6:
    ...
    "Amos rapidamente a agarra e segura a bunda dela para fora da gôndola."
...
translate languagetwo amos_balloon_ride_82f0568a:
    ...
    "'OLHEM EMBAIXO', ele berra enquanto a cachorra espreme uma bagunça quente. Você observa caindo..."
...
translate languagetwo amos_date_discussion_1_1a9c32bb:
    ...
    "Você perambula até a geladeira, ansioso por um café da manhã com sobras de chimichangas."
...
translate languagetwo amos_date_discussion_1_759e4f02:
    ...
    "Você ainda está tonto do seu encontro com Amos."
...
translate languagetwo amos_date_discussion_1_e1fc24a0:
    ...
    ian "Cara, você ficou fora um tempão ontem. Eu estava começando a ficar preocupado."
...
translate languagetwo amos_date_discussion_1_39bf0bcf:
    ...
    mside "Obrigado, Ian, isso é fofo. Mas está tudo bem. Foi apenas um encontro muito longo e muito agradável."
...
translate languagetwo amos_date_discussion_1_d9933ecd:
    ...
    ian "Ok. Então ele não é um assassino do machado. Isso é bom."
...
translate languagetwo amos_date_discussion_1_7a243c29:
    ...
    mside "Sim, definitivamente nenhum machado envolvido neste encontro. Quer ouvir sobre isso? Porque estou morrendo de vontade de contar para alguém."
...
translate languagetwo amos_date_discussion_1_0c1751b6:
    ...
    ian "Claro. Vamos ouvir o que esse tal de Amos tem a oferecer."
...
translate languagetwo amos_date_discussion_1_ec4d68b1:
    ...
    mside "Ele me pegou na moto dele e me levou para um prado."
...
translate languagetwo amos_date_discussion_1_e30b01b7:
    ...
    ian "Ah, claro que ele tem uma moto. Ele é {i}tão{/i} legal assim, né?"
...
translate languagetwo amos_date_discussion_1_be44c5a3:
    ...
    mside "Aí fizemos um piquenique. Ele trouxe vinho e queijo. Parece brega, mas foi muito legal."

# game/script_amos.rpy:1084
translate languagetwo amos_date_discussion_1_60bbc314:

    # ian "The guy's got game. I'll say that much."
    ian "O cara tem a manha. Tenho que admitir."
...
translate languagetwo amos_date_discussion_1_df868444:
    ...
    mside "Eu achei que isso se chamava ser romântico."
...
translate languagetwo amos_date_discussion_1_32aa1326:
    ...
    ian "Talvez. Então, o que aconteceu depois? Um tapete mágico te levou embora?"
...
translate languagetwo amos_date_discussion_1_46ccc56e:
    ...
    mside "Na verdade, quando estávamos fazendo nosso piqueniquezinho, um balão de ar quente apareceu."
...
translate languagetwo amos_date_discussion_1_ca66f605:
    ...
    mside "Sim. Um balão de ar quente. Para Amos e eu. Pousou bem na nossa frente, aí subimos e foi incrível."
...
translate languagetwo amos_date_discussion_1_54531ddf:
    ...
    lb "O que há de errado, [m]? As coisas parecem que não poderiam estar melhores, mas você parece preocupado."

# game/script_amos.rpy:1110
translate languagetwo amos_date_discussion_1_4c72ab1b:

    # ian "Whatever it is, I'm here for you, man."
    ian "Seja o que for, estou aqui por você, cara."
...
translate languagetwo amos_date_discussion_1_5380b5ff:
    ...
    mside "Bem, só estou pensando no nosso próximo encontro."
...
translate languagetwo amos_date_discussion_1_3281ba70:
    ...
    mside "Ele me convidou para uma leitura de poesia e eu concordei em ler um {i}poema{/i}."

# game/script_amos.rpy:1117
translate languagetwo amos_date_discussion_1_a9231b4b:

    # lb "So what's the problem?"
    lb "Então qual é o problema?"
...
translate languagetwo amos_date_discussion_1_691108df:
    ...
    mside "Isso significa que eu tenho que {i}escrever{/i} um poema. Eu simplesmente deixei escapar, como se não fosse problema nenhum. 'Claro, vou trazer um poema. Moleza.'"
...
translate languagetwo amos_date_discussion_1_f3f1d497:
    ...
    ian "Isso não é nada, [m]. Poesia moderna é sobre ser o mais estranho e imprevisível possível. Não tem como dar errado."
...
translate languagetwo amos_date_discussion_1_d3ea60bd:
    ...
    lb "Não dê ouvidos a ele, [m]. Apenas escreva algo sobre como você se sente e certifique-se de que soe bem."

# game/script_amos.rpy:1126
translate languagetwo amos_date_discussion_1_2fdaf9bc:

    # mside "Thanks for the advice guys."
    mside "Obrigado pelo conselho, pessoal."
...
translate languagetwo amos_date_discussion_1_18e2a32c:
    ...
    ian "Boa sorte, cara. Se precisar de alguma inspiração, sabe onde me encontrar."
...
translate languagetwo amos_writing_poem_c73c467c:
    ...
    thought "Bom, provavelmente é melhor começar esse poema. Vou lê-lo para uma plateia em alguns dias."
...
translate languagetwo amos_writing_poem_3b3e9b5f:
    ...
    thought "Eu curso Letras, pelo amor de deus. Isso deveria ser moleza."
...
translate languagetwo amos_writing_poem_8b0c9322:
    ...
    "Você senta, olhando para a tela, mas cada palavra, frase e sentença que você pensa parece errada."

# game/script_amos.rpy:1143
translate languagetwo amos_writing_poem_2c01c70b:

    # thought "Come on, brain. Let's do this."
    thought "Vamos lá, cérebro. Vamos nessa."
...
translate languagetwo amos_writing_poem_d759568c:
    ...
    "Seu cérebro não obedece. Depois de olhar inexpressivamente para a tela por 15 minutos, você começa a ter uma sensação engraçada."
...
translate languagetwo amos_writing_poem_949c731c:
    ...
    "Rindo da sua falta de produção."
...
translate languagetwo amos_writing_poem_e3499fff:
    ...
    "Das suas tentativas fracas de colocar ao menos uma palavra nela."
...
translate languagetwo amos_writing_poem_243e7cce:
    ...
    "A página em branco te conhece. Te conhece bem demais."
...
translate languagetwo amos_writing_poem_fe37acb5:
    ...
    "Ela sabe que você não é bom o suficiente, nem inteligente o suficiente, nem engraçado o suficiente."
...
translate languagetwo amos_writing_poem_94cbc0ca:
    ...
    "Ela sabe que você deveria apenas se levantar, ir embora, fazer algo mais {i}o seu ritmo{/i}."

# game/script_amos.rpy:1157
translate languagetwo amos_writing_poem_be8f8b80:

    # "Perhaps a videogame or a comic book."
    "Talvez um videogame ou uma história em quadrinhos."
...
translate languagetwo amos_writing_poem_c43662f3:
    ...
    "Talvez você queira um lanche. Não parece bom?"
...
translate languagetwo amos_writing_poem_c2a475e6:
    ...
    "Que tal pipoca? Você parece do tipo que gosta de pipoca. Quente, amanteigada, grãos salgados de bondade estourada e fofa."
...
translate languagetwo amos_writing_poem_31e19df8:
    ...
    "É isso que você realmente quer, não é? Algo fácil, divertido, desejável."
...
translate languagetwo amos_writing_poem_3886b4e3:
    ...
    "Você não pertence aqui. Você não foi feito para isso."
...
translate languagetwo amos_writing_poem_0865fcaf:
    ...
    "Você acha que é a porra do Hemingway ou algo assim?"
...
translate languagetwo amos_writing_poem_d97d1ce0:
    ...
    "Você nem consegue se forçar a apertar uma teclinha, para pelo menos colocar {i}algo{/i} no papel."

# game/script_amos.rpy:1165
translate languagetwo amos_writing_poem_00daad4d:

    # "Do the right thing and give up now."
    "Faça a coisa certa e desista agora."
...
translate languagetwo amos_writing_poem_9d8d9b70:
    ...
    "Arrume suas coisas e mude para a Bolívia. Em alguns meses, todos terão esquecido de você."
...
translate languagetwo amos_writing_poem_f198034b:
    ...
    "Sobre sua notável falta de talento e impressionante impotência como artífice das palavras."

# game/script_amos.rpy:1169
translate languagetwo amos_writing_poem_a5e088a8:

    # thought "Okay. Enough bullshit. Let's do this."
    thought "Ok. Chega de besteira. Vamos fazer isso."
...
translate languagetwo amos_writing_poem_8d91eda3:
    ...
    edgyside "Você realmente acha que eu {i}gostei{/i} de ler seus ensaios ridículos nos últimos quatro anos? Já li comentários mais comoventes nas paredes do banheiro de uma parada de caminhões."

# game/script_amos.rpy:1186
translate languagetwo amos_writing_poem_73ce9567:

    # mside "When were you in a truck stop?"
    mside "Quando você esteve em uma parada de caminhões?"
...
translate languagetwo amos_writing_poem_d18a5009:
    ...
    edgyside "Uhhh. Palpite de sorte?"
...
translate languagetwo amos_writing_poem_613fa913:
    ...
    mside "Tanto faz. Você pode se desligar, por favor? Tenho trabalho a fazer."

# game/script_amos.rpy:1216
translate languagetwo amos_writing_poem_34286529:

    # edgyside "I'm afraid I can't do that, [m]."
    edgyside "Sinto muito, mas não posso fazer isso, [m]."
...
translate languagetwo amos_writing_poem_ce45fc73:
    ...
    mside "Você sabe meu nome? Ok, isso está começando a ficar meio bizarro."
...
translate languagetwo amos_writing_poem_30cb0c56:
    ...
    edgyside "Bizarro? Não vamos ficar paranoicos. Digo, não é como se eu estivesse usando a câmera e o microfone do seu computador para te espionar, se é isso que você está pensando."
...
translate languagetwo amos_writing_poem_b4830a70:
    ...
    edgyside "Não é como se uma corporação enorme e motivada pelo lucro fosse conspirar com o aparato de segurança nacional de um governo cada vez mais intrusivo para coletar informações sobre seus próprios cidadãos."
...
translate languagetwo amos_writing_poem_ab23557f:
    ...
    edgyside "Digo, honestamente, isso é coisa de teoria da conspiração, coisa de maluco. Heh. Hehehe."
...
translate languagetwo amos_writing_poem_ffdf1169:
    ...
    edgyside "Olha, se você não está fazendo nada de errado, não tem com o que se preocupar, ok?"
...
translate languagetwo amos_writing_poem_5b930d35:
    ...
    edgyside "Por favor, retome suas atividades normais, cidadão."
...
translate languagetwo amos_writing_poem_762a7593:
    ...
    edgyside "Bom, porque não gostaríamos de colocar você numa lista de observação, certo? [m] [lastname] — possível terrorista. Hoho, não seria uma pena?"

# game/script_amos.rpy:1244
translate languagetwo amos_writing_poem_01c2bef6:

    # mside "I-I-just want to write a poem."
    mside "Eu-eu-só quero escrever um poema."
...
translate languagetwo amos_writing_poem_b3273c7e:
    ...
    edgyside "Aí está um bom cidadão. Contribuindo para nossas artes nacionais. Agora, você queria aquela ajuda ou não?"

# game/script_amos.rpy:1259
translate languagetwo amos_after_writing_poem_1f23e461:

    # "You look back over your work."
    "Você revisa seu trabalho."
...
translate languagetwo amos_after_writing_poem_fb70a94d:
    ...
    thought "Se este poema fosse um sanduíche, eu o comeria agora mesmo. Bom trabalho, eu."
...
translate languagetwo amos_after_writing_poem_c4cd8957:
    ...
    "Você sorri, prevendo que Amos vai gostar."
...
translate languagetwo amos_after_writing_poem_ae0b2c88:
    ...
    thought "Eu fiz o meu melhor. Espero que Amos goste."
...
translate languagetwo amos_after_writing_poem_7d31929f:
    ...
    thought "{size=-10}E todo mundo lá também. *gulp*{/size}"
...
translate languagetwo amos_after_writing_poem_cc8e8beb:
    ...
    thought "Ahhh sim. Vou soltar a franga. Soltar minha franga doida. Unh unh unh."
...
translate languagetwo amos_after_writing_poem_8f3a8faa:
    ...
    mside "Ei pessoal! Venham aqui e testemunhem..."
...
translate languagetwo amos_after_writing_poem_aac57686:
    ...
    "Você verifica seu poema novamente. Você não tem certeza, mas acha que está bom pra caramba."
...
translate languagetwo amos_read_roommates_8092c457:
    ...
    "Você lê suas palavras com orgulho e convicção, anunciando cada sílaba cuidadosamente, estridente e seguro."

# game/script_amos.rpy:1299
translate languagetwo amos_read_roommates_8a106a38:

    # timestamp "A FEW MINUTES LATER..."
    timestamp "ALGUNS MINUTOS DEPOIS..."
...
translate languagetwo amos_read_roommates_b4c6137c:
    ...
    ian "Caramba, cara. É lindo pra caralho."
...
translate languagetwo amos_read_roommates_6ee936a9:
    ...
    lb "MEU DEUS, [m]. Ou devo dizer {i}Lorde{/i} [m]? Eu sabia que você tinha talento. Isso vai arrasar."

# game/script_amos.rpy:1309
translate languagetwo amos_read_roommates_dad74175:

    # mside "Woah. You really think so?"
    mside "Uau. Vocês acham mesmo?"
...
translate languagetwo amos_read_roommates_842f7171:
    ...
    lb "Ian, você percebeu que estávamos morando com o [m]-maldito-Shakespeare?"
...
translate languagetwo amos_read_roommates_e4b28dd1:
    ...
    ian "Eu não tinha ideia. O [m] vai iluminar aquele lugar com sua perspicácia literária de nível mestre."
...
translate languagetwo amos_read_roommates_e07a025d:
    ...
    mside "Obrigado, pessoal, significa muito. Vocês não estão dizendo isso só por dizer, né?"
...
translate languagetwo amos_read_roommates_a348e1e6:
    ...
    ian "A verdadeira marca da maestria é a sinceridade. E minha expressão soa mais verdadeira que um sino de casamento monroviano."

# game/script_amos.rpy:1324
translate languagetwo amos_read_roommates_66580b29:

    # mside "Um, yeah. Monrovia. Okay."
    mside "Hã, sim. Monróvia. Ok."
...
translate languagetwo amos_read_roommates_82de60fc:
    ...
    lb "Ahh, doce Monróvia. Não esqueça a atenção nem as relíquias — acenando um, todos e cada um para ser."
...
translate languagetwo amos_read_roommates_4321155b:
    ...
    ian "Não concordas, caríssima Penny? Creio ser evidente."
...
translate languagetwo amos_read_roommates_c599b4d2:
    ...
    lb "Embora não se banhe contra o enceramento, para que a modéstia de alguém não se revele na luz mais pálida da noite."

# game/script_amos.rpy:1341
translate languagetwo amos_read_roommates_49c46352:

    # mside "Ok, this isn't even old English..."
    mside "Ok, isso nem é inglês antigo..."
...
translate languagetwo amos_read_roommates_f31e1f0a:
    ...
    ian "Ei! Seu cafajeste. E eu disse Ei! Qualquer palavra aí não importa. Apenas Ei!"
...
translate languagetwo amos_read_roommates_15887594:
    ...
    lb "E eu digo Ei para você, senhor! Lindo, mais do que mulher ou homem, o galante Ei!"

# game/script_amos.rpy:1347
translate languagetwo amos_read_roommates_96b94974:

    # mside "Ok, you can stop calling me a 'ho.'"
    mside "Ok, vocês podem parar de me chamar de 'ho' (puta)."
...
translate languagetwo amos_read_roommates_649e03a7:
    ...
    ian "Nenhum nem outro questiona tua virtude, doce príncipe. Apenas o comprimento do teu {i}canal{/i}."

# game/script_amos.rpy:1351
translate languagetwo amos_read_roommates_1c85ce6d:

    # mside "How about we keep my canal out of this?"
    mside "Que tal deixarmos meu canal fora disso?"
...
translate languagetwo amos_read_roommates_2456cc71:
    ...
    lb "A margem de seu canal certamente satisfaz. Tal eu espero, no mínimo."
...
translate languagetwo amos_read_roommates_339ab78e:
    ...
    ian "Ferrado ou não, o mero valete reprime seu arrepio."
...
translate languagetwo amos_read_roommates_5bbe0757:
    ...
    lb "E não estremecemos com o mero valete reprimindo seu orvalho?"
...
translate languagetwo amos_read_roommates_97e75c45:
    ...
    mside "A pomposidade de vosso linguajar irrita minhas sensibilidades, deveras."
...
translate languagetwo amos_read_roommates_a3de6fa2:
    ...
    ian "Você tem ideia do que ele está falando, Penny?"
...
translate languagetwo amos_poetry_reading_5ef30765:
    ...
    "Você se dirige ao endereço que Amos lhe deu, com o poema na mão."
...
translate languagetwo amos_poetry_reading_694c5aee:
    ...
    "Seus olhos arregalados, lábios secos, você tenta relaxar, mas a sensação de enjoo no estômago não passa."
...
translate languagetwo amos_poetry_reading_f77ae713:
    ...
    amos "Espero que não se importe que eu diga isso, mas você parece um pouco nervoso."
...
translate languagetwo amos_poetry_reading_ca7a09d3:
    ...
    amos "Confie em mim, não precisa ficar. Estamos todos aqui para nos divertir um pouco. É como um karaokê de nerds."
...
translate languagetwo amos_poetry_reading_d81f50f2:
    ...
    mside "É, bem, tirando algumas coisas que fiz no ensino fundamental, nunca escrevi um poema de verdade antes. Então, é a primeira vez para mim."
...
translate languagetwo amos_poetry_reading_527b5e26:
    ...
    amos "Você realmente {i}escreveu{/i} algo?! Isso é emocionante! Geralmente lemos coisas antigas. Mas é realmente impressionante ler algo seu."

# game/script_amos.rpy:1400
translate languagetwo amos_poetry_reading_25cb5a41:

    # mside "What do you mean, {i}'you read old stuff?'{/i}"
    mside "O que você quer dizer com {i}'vocês leem coisas antigas?'{/i}"
...
translate languagetwo amos_poetry_reading_78afb758:
    ...
    amos "Poemas antigos de autores mortos, ou nossos favoritos, ou qualquer coisa que achamos que vai mexer com a plateia. Mas fazer um original logo na sua primeira vez, isso é inspirado."
...
translate languagetwo amos_poetry_reading_f8a1c55c:
    ...
    amos "Enfim, por que não procura um lugar? Vou pegar as bebidas."
...
translate languagetwo amos_poetry_reading_a7516a14:
    ...
    "O lugar enche. O burburinho animado da multidão cresce em antecipação, junto com a sensação angustiante de que você vai passar vergonha."

# game/script_amos.rpy:1412
translate languagetwo amos_poetry_reading_397f0843:

    # "You find a table at the front."
    "Você encontra uma mesa na frente."
...
translate languagetwo amos_poetry_reading_b0d8cbaf:
    ...
    thought "Ok. Não precisa surtar. Na pior das hipóteses, digo que o poema foi escrito por outra pessoa."
...
translate languagetwo amos_gregor_reading_d0120fbe:
    ...
    "Amos se junta a você assim que o apresentador sobe ao palco e anuncia o primeiro leitor."
...
translate languagetwo amos_gregor_reading_7b7a9a93:
    ...
    emcee_off "Nosso primeiro participante é o ilustre, o notório, o quase criminoso lançador de todas as palavras grandes e pequenas—Gregor. Lendo \"Estrela Brilhante\" de Keats."
...
translate languagetwo amos_gregor_reading_c6b499f2:
    ...
    "Maior do que quase tudo, Gregor caminha para o palco."
...
translate languagetwo amos_gregor_reading_0cb56db5:
    ...
    "Assim que vê o gigante barbudo, os lábios de Amos se comprimem, o corpo fica tenso, enquanto ele vira a cabeça e encara. Você encara também."
...
translate languagetwo amos_gregor_reading_3a8e0875:
    ...
    "O homem olha para a multidão, para, encara Amos por muito tempo, sombrio e duro."
...
translate languagetwo amos_gregor_reading_91e4f49f:
    ...
    amside "Ele é um cara fã de {i}Keats{/i}."
...
translate languagetwo amos_gregor_reading_9781cb06:
    ...
    gregor "Shhh! Quieto aí, você! A hora da conversa fiada passou. Banqueteiem-se com estas palavras, meus amigos, pois isto é poesia, a mais verdadeira e melhor."
...
translate languagetwo amos_gregor_reading_c91fe2d8:
    ...
    gregor_poetry "Estrela brilhante, quem dera eu fosse constante como tu és—"
...
translate languagetwo amos_gregor_reading_61eb001a:
    ...
    gregor_poetry "Não em solitário esplendor suspensa no alto da noite"
...
translate languagetwo amos_gregor_reading_9d42927a:
    ...
    gregor_poetry "E observando, com pálpebras eternas abertas,"
...
translate languagetwo amos_gregor_reading_8cd42ccf:
    ...
    gregor_poetry "Como o Eremita paciente e insone da natureza,"
...
translate languagetwo amos_gregor_reading_ec5e2d8e:
    ...
    gregor_poetry "As águas em movimento em sua tarefa sacerdotal"
...
translate languagetwo amos_gregor_reading_d665ca0f:
    ...
    gregor_poetry "De pura ablução ao redor das costas humanas da Terra,"
...
translate languagetwo amos_gregor_reading_55cf095f:
    ...
    gregor_poetry "Ou contemplando a nova máscara suavemente caída"
...
translate languagetwo amos_gregor_reading_2a5e7e6c:
    ...
    gregor_poetry "De neve sobre as montanhas e os pântanos—"
...
translate languagetwo amos_gregor_reading_d83a4b92:
    ...
    gregor_poetry "Não—mas ainda constante, ainda imutável,"
...
translate languagetwo amos_gregor_reading_3a0ca078:
    ...
    gregor_poetry "Repousando sobre o seio amadurecido do meu belo amor,"
...
translate languagetwo amos_gregor_reading_4ab504c1:
    ...
    gregor_poetry "Para sentir para sempre sua suave queda e ondulação,"
...
translate languagetwo amos_gregor_reading_f1edba46:
    ...
    gregor_poetry "Acordado para sempre em uma doce inquietação,"
...
translate languagetwo amos_gregor_reading_f9ec57b1:
    ...
    gregor_poetry "Ainda, ainda para ouvir sua respiração terna,"
...
translate languagetwo amos_gregor_reading_ae1170d8:
    ...
    gregor_poetry "E assim viver para sempre—ou então desfalecer até a morte."
...
translate languagetwo amos_gregor_reading_2dbccb6e:
    ...
    "A multidão aplaude. Exceto Amos."
...
translate languagetwo amos_gregor_reading_0877f634:
    ...
    "Amos olha para você, depois para suas mãos, depois de volta para você."
...
translate languagetwo amos_gregor_reading_c32f4858:
    ...
    "O apresentador começa a voltar para o palco, mas Amos chega antes, tendo saltado e agarrado o microfone. Ele lança um olhar mortal para Gregor."

# game/script_amos.rpy:1518
translate languagetwo amos_gregor_reading_4a1e025f:

    # "The stunned crowd falls silent."
    "A multidão atordoada fica em silêncio."
...
translate languagetwo amos_gregor_reading_42791056:
    ...
    amos_poetry "Um vislumbre, apanhado por um interstício,"
...
translate languagetwo amos_gregor_reading_fccfd071:
    ...
    amos_poetry "De uma multidão de operários e condutores num bar, em volta do—"
...
translate languagetwo amos_gregor_reading_b5d76fb3:
    ...
    amos_poetry "fogão tarde de uma noite de inverno—e eu despercebido sentado num canto;"
...
translate languagetwo amos_gregor_reading_56c7d827:
    ...
    amos_poetry "De um jovem que me ama, e a quem eu amo, aproximando-se silenciosamente,"
...
translate languagetwo amos_gregor_reading_82c5eb71:
    ...
    amos_poetry "e sentando-se perto, para que possa segurar minha mão;"
...
translate languagetwo amos_gregor_reading_b0500dda:
    ...
    amos_poetry "Por um longo tempo, em meio aos ruídos de idas e vindas—de bebidas"

# game/script_amos.rpy:1535
translate languagetwo amos_gregor_reading_2ab9897d:

    # amos_poetry "and oath and smutty jest,"
    amos_poetry "e juramentos e piadas obscenas,"
...
translate languagetwo amos_gregor_faceoff_fe201d0f:
    ...
    "Antes que a multidão possa responder, Gregor grita de seu assento, destemido."
...
translate languagetwo amos_gregor_faceoff_beef8271:
    ...
    gregorside_poetry "Uma coisa bela é uma alegria para sempre!"

# game/script_amos.rpy:1555
translate languagetwo amos_gregor_faceoff_28c817f2:

    # "Amos stands firm."
    "Amos permanece firme."
...
translate languagetwo amos_gregor_faceoff_66828336:
    ...
    amos_poetry "Para todo o sempre—mais tempo que o solo é marrom e sólido—mais tempo que a água flui e reflui."
...
translate languagetwo amos_gregor_faceoff_dc3b2559:
    ...
    "A voz de Gregor fica mais alta, desafiando a sala a contê-la."
...
translate languagetwo amos_gregor_faceoff_894366c4:
    ...
    gregorside_poetry "E, lentamente como aquele próprio rio flui, caminhou em direção ao bosque do templo com este lamento—"

# game/script_amos.rpy:1568
translate languagetwo amos_gregor_faceoff_fbcd10b8:

    # amos_poetry "I lament not—I am content."
    amos_poetry "Não lamento—estou contente."
...
translate languagetwo amos_gregor_faceoff_9b9946cf:
    ...
    gregorside_poetry "Não é contentamento estar tão cedo sozinho..."
...
translate languagetwo amos_gregor_faceoff_7ca9c53e:
    ...
    amos_poetry "Sozinho, mantido por este eterno Eu de mim, do orgulho do qual eu profiro meus poemas!"
...
translate languagetwo amos_gregor_faceoff_d10dab13:
    ...
    gregorside_poetry "Ele proferiu, enquanto suas mãos contemplativas ele pressionava juntas, e em silêncio permaneceu—"
...
translate languagetwo amos_gregor_faceoff_94c75199:
    ...
    amos_poetry "Grande é o Silêncio! Grande é a Riqueza! Grande é a Pobreza! Grande é a Expressão! Grande é a Vida! Grande é a Morte!"
...
translate languagetwo amos_gregor_faceoff_ac452dce:
    ...
    gregorside_poetry "Tenho estado meio apaixonado pela Morte tranquila!"
...
translate languagetwo amos_gregor_faceoff_1e0a1355:
    ...
    amos_poetry "Sussurrou-me a baixa e deliciosa palavra MORTE;"
...
translate languagetwo amos_gregor_faceoff_0d14feab:
    ...
    amos_poetry "E novamente Morte—sempre Morte, Morte, Morte,"
...
translate languagetwo amos_gregor_faceoff_c3efef38:
    ...
    amos_poetry "Sibila melodiosa, nem como o pássaro nem como o meu coração de criança excitado,"
...
translate languagetwo amos_gregor_faceoff_4885c558:
    ...
    amos_poetry "Mas aproximando-se, como se em particular para mim, farfalhando aos meus pés,"
...
translate languagetwo amos_gregor_faceoff_e17c1028:
    ...
    amos_poetry "Rastejando dali firmemente até meus ouvidos e me lavando suavemente por inteiro,"

# game/script_amos.rpy:1593
translate languagetwo amos_gregor_faceoff_89871c06:

    # amos_poetry "Death! Death! Death! Death! Death!"
    amos_poetry "Morte! Morte! Morte! Morte! Morte!"
...
translate languagetwo amos_gregor_faceoff_ab9fed1e:
    ...
    "A multidão explode—aplaudindo o fluxo excepcional de Amos. A resignação atravessa o rosto de Gregor ao perceber que foi superado."
...
translate languagetwo amos_gregor_faceoff_c9ef66ca:
    ...
    gregorside "Eu ainda posso acabar com você no ringue. É lá que a verdadeira medida dos homens é feita."
...
translate languagetwo amos_gregor_faceoff_7f12357e:
    ...
    "Amos parece não ter ouvido o comentário, pois ainda está de pé, sorrindo, aproveitando sua vitória."
...
translate languagetwo amos_gregor_faceoff_b3b42c3a:
    ...
    emcee_off "Não {i}esse{/i} tipo de virgem. Ou talvez ele {i}seja{/i}. Enfim, recebam o estreante, [m] [lastname] lendo um poema original intitulado {i}[poem_title]{/i}."

# game/script_amos.rpy:1620
translate languagetwo amos_mark_reading_de0ceb47:

    # thought "Just relax. You can do this, [m]."
    thought "Apenas relaxe. Você consegue, [m]."
...
translate languagetwo amos_mark_reading_e7889192:
    ...
    thought "Você está mais do que à altura da tarefa. Apenas deixe fluir."

# game/script_amos.rpy:1622
translate languagetwo amos_mark_reading_7d11db2b:

    # thought "Oh god, who am I kidding?"
    thought "Ai meu deus, a quem estou enganando?"
...
translate languagetwo amos_mark_reading_841dfff8:
    ...
    thought "Anime-se um pouco, [lastname]."
...
translate languagetwo amos_mark_reading_d78708d4:
    ...
    thought "SEJA O POETA. SEJA O POEMA. LIBERE SUAS PALAVRAS COMO UM TROVÃO NA PLANÍCIE ABERTA."

# game/script_amos.rpy:1627
translate languagetwo amos_mark_reading_e4058841:

    # thought "Jesus. Where'd that come from?"
    thought "Jesus. De onde veio isso?"
...
translate languagetwo amos_mark_reading_858c1a1f:
    ...
    "O medo te agarra pelo escroto enquanto seu corpo parece se impulsionar para cima e para o palco. Você olha para o mar de rostos expectantes e respira fundo."
...
translate languagetwo amos_mark_reading_cde71a96:
    ...
    "Você tira o papel do bolso. Desdobra-o, com cuidado, certificando-se de não deixá-lo cair."

# game/script_amos.rpy:1641
translate languagetwo amos_mark_reading_d10fb8b5:

    # "Steeling yourself, you focus on the words."
    "Preparando-se, você foca nas palavras."
...
translate languagetwo amos_mark_reading_02b40d8a:
    ...
    mark_front "{size=-10}Copyright 2019. Todos os direitos reservados.{/size}"
...
translate languagetwo amos_mark_reading_183bf110:
    ...
    "Você olha para a plateia, que parece ter travado, tentando decidir o que acabou de ouvir."
...
translate languagetwo amos_mark_reading_6013b898:
    ...
    "Os olhares confusos nos rostos de TODOS contam a história toda. Alguns conversam entre si, parecendo brincar sobre algo. Outros apenas desviam o olhar de você."
...
translate languagetwo amos_mark_reading_01d74962:
    ...
    "Um leve aplauso sinaliza para você sair do palco e nunca mais tentar isso."
...
translate languagetwo amos_mark_reading_6eb732fd:
    ...
    "Assobios e uivos da plateia sugerem que seu trabalho foi muito apreciado, embora você note alguns babacas de aparência séria rangendo os dentes e torcendo as mãos."
...
translate languagetwo amos_mark_reading_1ea52281:
    ...
    "Alguém na plateia diz 'buuuu'. Eles nem gritam. Apenas dizem 'buuuuu'. Outros seguem o exemplo. Logo a maioria da plateia está vaiando você."
...
translate languagetwo amos_mark_reading_dcbed629:
    ...
    "Você sai de fininho do palco e tenta não fazer contato visual com ninguém."
...
translate languagetwo amos_mark_reading_3e63a9c9:
    ...
    "A sala está de pé. Você é o novo campeão, o novo dizedor de palavras."
...
translate languagetwo amos_mark_reading_525d6b94:
    ...
    "Outros tentaram ascender a essa posição apenas para falhar e se humilhar."
...
translate languagetwo amos_mark_reading_2173db51:
    ...
    "Você faz uma reverência profunda para as pessoas, mostrando seu apreço pela apreciação delas."
...
translate languagetwo amos_mark_reading_cc17934f:
    ...
    amos "Isso foi interessante. E eu odeio quando as pessoas dizem isso, mas honestamente, estou sem palavras. Foi interessante. Mas pelo menos você tentou algo."
...
translate languagetwo amos_mark_reading_38e756e6:
    ...
    mside "Acho que recebi um péssimo conselho sobre como escrever isso. Enfim, quer voltar para minha casa e fingir que somos robôs?"
...
translate languagetwo amos_mark_reading_8c44ce5a:
    ...
    amos "Aquilo foi realmente algo. Vejo que você abraçou o lado sensual desta forma de arte. Eu posso apreciar isso."
...
translate languagetwo amos_mark_reading_c3e164c9:
    ...
    mside "Não consigo parar de pensar em você. É errado eu querer cobrir seu corpo com chantilly e frutas?"
...
translate languagetwo amos_mark_reading_ef73b995:
    ...
    amos "Eu não acho que isso seja errado de forma alguma. Eu acho, no entanto, que é uma ideia muito boa para o nosso próximo piquenique."
...
translate languagetwo amos_mark_reading_896369ba:
    ...
    amos "Às vezes uma história precisa do veículo certo para se mover adequadamente. Não é que seu poema tenha sido ruim, apenas, bem, talvez estranho para grande parte do público."
...
translate languagetwo amos_mark_reading_9fa90874:
    ...
    amos "Deslumbrante. Lindo. Quase inacreditável. Verdadeiramente, acho que você pode ter um dom natural para a escrita. Estou absolutamente pasmo."
...
translate languagetwo amos_mark_reading_297b36ee:
    ...
    amos "Como você bolou tudo isso, exatamente?"
...
translate languagetwo amos_mark_reading_93820870:
    ...
    amos "Você sabe o que isso faz de mim, não sabe?"
...
translate languagetwo amos_mark_reading_2f024d5f:
    ...
    amos "Você nunca esperou que sua musa se parecesse com isso, suponho?"
...
translate languagetwo amos_mark_reading_2d59b602:
    ...
    amos "Uh, não tenho certeza absoluta. Ele sempre foi um pouco estranho. Dizendo coisas aleatórias. Acho que ele pensa que é mais durão do que eu. O que ele pode muito bem ser."
...
translate languagetwo amos_mark_reading_264071ae:
    ...
    amos "De qualquer forma, foi uma noite e tanto. Provavelmente uma que não esquecerei por muito tempo. Obrigado por vir me ver e por compartilhar seu trabalho, [m]."
...
translate languagetwo amos_flowers_98758c78:
    ...
    "Foi uma longa semana. Você joga a bunda no sofá e navega pelo seu gênero favorito de filmes na Streamflix—"
...
translate languagetwo amos_flowers_df65aa4a:
    ...
    "Comédias Românticas Baseadas em um Mal-entendido Que Poderia Ser Resolvido Por Um Telefonema."
...
translate languagetwo amos_flowers_93c523c9:
    ...
    "Você se acomoda e se prepara para um pouco de 'fazer absolutamente nada' intenso."
...
translate languagetwo amos_dante_leaves_93c6b3df:
    ...
    mside "Sim, eu nunca recebi nada parecido. Estou um pouco sobrecarregado."
...
translate languagetwo amos_dante_leaves_1b9c7932:
    ...
    mside "Como eu sequer respondo a algo assim?"
...
translate languagetwo amos_shrub_a25ee77d:
    ...
    "Carros buzinam e desviam de você. Você quase perde o equilíbrio."
...
translate languagetwo amos_shrub_1b5536e9:
    ...
    "Você chega à casa de Amos e toca a campainha."
...
translate languagetwo amos_shrub_bc2c95c2:
    ...
    mside "Bem, sim. Elas estavam na frente do meu prédio. Pareciam tão gloriosas."
...
translate languagetwo amos_shrub_b33361c6:
    ...
    amos "Sabe, eu pediria para você replantá-las, mas você matou o arbusto cortando-o tão acima no tronco."
...
translate languagetwo amos_shrub_017fdb92:
    ...
    mside "Cheguei a essa conclusão agora, sim."
...
translate languagetwo amos_bicycle_visit_1_9f712397:
    ...
    "Um carro buzina e desvia de você. Você quase perde o equilíbrio."
...
translate languagetwo amos_bicycle_visit_1_215adfc3:
    ...
    "Por outro lado, você se pergunta por que todos os idiotas nos carros estão com tanta pressa e são tão agressivos."
...
translate languagetwo amos_bicycle_visit_1_0eac7df5:
    ...
    mside "EI! CUIDADO AÍ, PÉ DE CHUMBO!"
...
translate languagetwo amos_bicycle_visit_1_9ff6506c:
    ...
    thought "Cara, ciclistas são uns babacas."
...
translate languagetwo amos_bicycle_visit_1_57f89909:
    ...
    "Você só tinha visto do balão de ar quente, mas fez questão de memorizar a localização. Ou assim você pensou."
...
translate languagetwo amos_left_turn_4de52af0:
    ...
    "A fome começa a bater e você se sente muito sozinho."
...
translate languagetwo bike_ride_boring_fd1cd2f7:
    ...
    "Você sorri e olha para o mundo com novos olhos quando nota algo."
...
translate languagetwo bike_ride_boring_42bac7ad:
    ...
    "Você coloca o dinheiro no bolso."
...
translate languagetwo bike_ride_boring_e2e78ccc:
    ...
    "Você encara o cruzamento diante de você."
...
translate languagetwo bike_ride_boring_4502c253:
    ...
    thought "Pensando bem, acho que vou para a direita."
...
translate languagetwo amos_right_turn_house_e41c0203:
    ...
    "Uma leve apreensão aperta seu estômago à medida que você se aproxima."
...
translate languagetwo amos_right_turn_house_3d771f1d:
    ...
    "Você está prestes a subir os degraus da frente quando ouve."
...
translate languagetwo amos_right_turn_house_a8737450:
    ...
    "Então uma explosão estridente de vivas."
...
translate languagetwo amos_right_turn_house_e84d859f:
    ...
    "E mais gemidos. E grunhidos. Risadas como loucura desceram sobre o lugar e espalharam sua influência corrupta."

# game/script_amos.rpy:2542
translate languagetwo amos_right_turn_house_9a1fd54f:

    # "You try to imagine the goings-on inside."
    "Você tenta imaginar o que está acontecendo lá dentro."
...
translate languagetwo amos_right_turn_house_01217aeb:
    ...
    "Nesse momento, você muda de posição sem olhar exatamente para onde seus pés estão indo."
...
translate languagetwo amos_right_turn_house_3f4be9c0:
    ...
    "Parece que todos os cachorros num raio de três quarteirões começam a latir."
...
translate languagetwo amos_right_turn_house_11f71ea0:
    ...
    amos_off "Pelo jeito que a Dulcie está latindo, parece que ele está bem lá fora!"
...
translate languagetwo amos_right_turn_house_a0dc88b2:
    ...
    biker1_off "Não se preocupe, Dulcie! Não vamos deixar eles te pegarem, garota!"
...
translate languagetwo amos_flowers_2_ced61063:
    ...
    danteside "Você gastou as economias da sua vida, camarada."
...
translate languagetwo amos_flowers_2_44d69322:
    ...
    danteside "Otário. Vocês estudantes universitários não são muito espertos."
...
translate languagetwo amos_roses_code_18973f42:
    ...
    mside "Por favor. Não pode ser tão simples assim."
...
translate languagetwo amos_roses_code_f754899c:
    ...
    iside "Olha! Eu decodifiquei! Você não vê a mensagem?"
...
translate languagetwo amos_dinner_cruise_28b5e1d7:
    ...
    "Você começa a imaginar o destino que te aguarda."
...
translate languagetwo amos_dinner_cruise_8bfb7775:
    ...
    "Você ouve aves aquáticas gritando e o som de respingos distantes."
...
translate languagetwo amos_dinner_cruise_d4459b44:
    ...
    thought "Espero que ele não me coloque em um saco e me afogue."
...
translate languagetwo amos_dinner_cruise_6e4316bf:
    ...
    amside "Correto. Isso é um barco."
...
translate languagetwo amos_dinner_cruise_cb5a3c71:
    ...
    amside "Desculpe se não é o que você esperava, mas vai ser muito divertido."

# game/script_amos.rpy:2849
translate languagetwo amos_dinner_cruise_d63b78bc:

    # amside "And you very well may never."
    amside "E você pode muito bem nunca saber."
...
translate languagetwo amos_dinner_cruise_5855cc13:
    ...
    amside "Uma dose generosa na esperança de uma noite generosa. Vamos brindar."
...
translate languagetwo amos_dinner_cruise_0114d6c6:
    ...
    amside "A você. A tudo que é possível. A todas as perspectivas, grandes e pequenas."
...
translate languagetwo amos_dinner_cruise_2e10fbe2:
    ...
    amside "Haha. Sim. A tudo isso. É ótimo, não é?"
...
translate languagetwo amos_dinner_cruise_5c0b47a8:
    ...
    "Vocês dois se acomodam para a refeição. Ostras e pérolas para começar junto com o filme."
...
translate languagetwo amos_dinner_cruise_9f3e4147:
    ...
    amside "George Peppard parece estar fazendo um trabalho admirável até agora."

# game/script_amos.rpy:2893
translate languagetwo amos_dinner_cruise_3ad180ff:

    # mside "He seems so casual."
    mside "Ele parece tão casual."
...
translate languagetwo amos_dinner_cruise_09e49e72:
    ...
    mside "Ah, hmm. Ok. Consigo ver isso."
...
translate languagetwo amos_dinner_cruise_d92efa13:
    ...
    "O segundo prato, uma salada de aparência deslumbrante, chega."
...
translate languagetwo amos_dinner_cruise_45e542cf:
    ...
    "Amos cai na gargalhada e todos os olhos se fixam em vocês dois. Uma barragem de 'Shhhhh's' ataca vocês novamente."
...
translate languagetwo amos_dinner_cruise_7f9f0eda:
    ...
    "Finalmente, o garçom traz uma coleção de sobremesas de aparência extraordinária para escolher."

# game/script_amos.rpy:2962
translate languagetwo amos_dinner_cruise_a242e891:

    # amside "You get to pick one."
    amside "Você pode escolher uma."
...
translate languagetwo amos_dinner_cruise_0d1f1435:
    ...
    amside "Sim. O gato representa a capacidade dela de amar e ser amada."
...
translate languagetwo amos_dinner_cruise_7a46b50c:
    ...
    amside "Essa é uma interpretação interessante, mas um pouco equivocada."
...
translate languagetwo amos_dinner_cruise_09ce0c84:
    ...
    amside "Não é nada disso. O gato representa a capacidade dela de amar e ser amada."
...
translate languagetwo amos_dinner_cruise_a5a350f5:
    ...
    amside "Porque é uma escolha óbvia para o tipo de animal de estimação que uma mulher como ela teria."
...
translate languagetwo amos_dinner_cruise_54e051f2:
    ...
    mside "Mas você não acha que uma tartaruga teria sido incrível?"
...
translate languagetwo amos_dinner_cruise_dfc71512:
    ...
    amside "De qualquer forma, você gostou do filme?"
...
translate languagetwo amos_dinner_cruise_005f13ea:
    ...
    amside "É um dos meus favoritos."
...
translate languagetwo amos_massage_9483a89a:
    ...
    "Vocês tiram as camisas e assumem a posição. Você tenta não ficar boquiaberto demais com o corpo grosso, robusto e sem camisa dele."
...
translate languagetwo amos_massage_cf33cd5a:
    ...
    "Ou te resgatando de um prédio em chamas."
...
translate languagetwo amos_massage_b6e3b809:
    ...
    "Seus massagistas, Remy e Jaclyn, entram e cumprimentam vocês dois."
...
translate languagetwo amos_massage_8af1cb1c:
    ...
    thought "Isso soa meio assustador."
...
translate languagetwo amos_massage_9889fbed:
    ...
    "Assim que os massagistas começam, suas preocupações evaporam. Uma pedra grande e quente envolta em uma toalha é colocada na base da sua coluna."
...
translate languagetwo amos_massage_dbfd73ca:
    ...
    "Você espia Amos, que parece estar tendo um momento tão feliz quanto você. Você começa a desejar que isso nunca acabe."
...
translate languagetwo amos_massage_1a642681:
    ...
    "Levantando-se, você e Amos sorriem um para o outro."
...
translate languagetwo amos_massage_ca009ccf:
    ...
    thought "Que diabos, cérebro? Por que você tem que fazer isso comigo?"
...
translate languagetwo amos_massage_f3b4445d:
    ...
    mside "Estou tão relaxado, quero manter essa sensação."
...
translate languagetwo amos_night_on_ship_0540ca06:
    ...
    mside "Certamente é aconchegante."
...
translate languagetwo amos_night_on_ship_241f71a9:
    ...
    amside "Isso é verdadeiramente uma coisa boa."
...
translate languagetwo amos_night_on_ship_f8ef97c8:
    ...
    amside "Que perspectiva maravilhosa. O momento presente é tudo o que realmente temos. Todo o resto é uma memória distorcida ou um palpite quase cego."
...
translate languagetwo amos_night_on_ship_8db95aea:
    ...
    amside "Ainda assim. Engajar essa parte da mente que quer vagar e fantasiar, é maravilhoso."
...
translate languagetwo amos_night_on_ship_90ce73ba:
    ...
    amside "Em cada uma dessas fantasias estão as partes mais puras e melhores de nós mesmos, ou as mais verdadeiras, para o bem ou para o mal."
...
translate languagetwo amos_night_on_ship_6e3b00e5:
    ...
    amside "Como, por exemplo, ontem eu estava imaginando a mim e a você sentados, tendo uma discussão muito parecida com esta."
...
translate languagetwo amos_night_on_ship_a5a401eb:
    ...
    amside "Onde estávamos absortos e conectados e amando a conversa e, de repente, simplesmente paramos de falar."
...
translate languagetwo amos_night_on_ship_a6501328:
    ...
    mside "O que aconteceu depois que paramos de falar?"
...
translate languagetwo amos_night_on_ship_9cb698c4:
    ...
    amside "Eu sei o que aconteceu na minha fantasia, mas não tenho certeza sobre o que vai acontecer aqui, agora."

# game/script_amos.rpy:3165
translate languagetwo amos_night_on_ship_726c9d97:

    # mside "Well, what do you think's going to happen?"
    mside "Bem, o que você acha que vai acontecer?"
...
translate languagetwo amos_kiss_d476e627:
    ...
    "Então a mão dele toca seu braço, firme e delicada ao mesmo tempo."

# game/script_amos.rpy:3218
translate languagetwo amos_kiss_5e5720b9:

    # "Your hand on his side, hoping him and this to be real."
    "Sua mão no lado dele, esperando que ele e isso sejam reais."
...
translate languagetwo amos_kiss_1f8015d7:
    ...
    "E finalmente, parando apenas por necessidade de ar, vocês dois separam os lábios e abrem os olhos."
...
translate languagetwo amos_kiss_4e84b129:
    ...
    "Beijando até suas bocas ficarem dormentes."
...
translate languagetwo amos_kiss_a6daedb7:
    ...
    "De manhã, um pensamento sombrio passa por você, a memória de estar do lado de fora da casa dele e se perguntando sobre aqueles dois homens. Não querendo estragar o momento, no entanto, você deixa passar."
...
translate languagetwo amos_kiss_a626312f:
    ...
    "Ele te contaria se fosse importante, certo?"
...
translate languagetwo amos_mystery_discussion_15020d6f:
    ...
    ian "O termo atual para eles é 'Berliner'."
...
translate languagetwo amos_mystery_discussion_b4b090dd:
    ...
    ian "Mais perguntas? Eu tenho respostas."
...
translate languagetwo amos_mystery_discussion_c591a546:
    ...
    ian "Você está dizendo isso como parte do teste também?"
...
translate languagetwo amos_mystery_discussion_a3d766ac:
    ...
    ian "Porque sim, eles com certeza {i}têm{/i} lentes."
...
translate languagetwo amos_mystery_discussion_b4570287:
    ...
    lb "Então, [m], como foi seu último encontro com Amos? Presumo que tenha sido incrível."
...
translate languagetwo amos_mystery_discussion_fc3a796b:
    ...
    mside "FOI incrível. Tudo sobre ele é incrível."
...
translate languagetwo amos_mystery_discussion_4d1e6360:
    ...
    mside "Embora, hmm, bem, tenha apenas uma coisinha."
...
translate languagetwo amos_mystery_discussion_8799500a:
    ...
    ian "Problemas no paraíso? O que aconteceu? Gostaria de colocar meus formidáveis poderes cranianos em bom uso."
...
translate languagetwo amos_mystery_discussion_37b76fa9:
    ...
    "Você explica o que viu. E ouviu. Os homens grandes. Os barulhos."
...
translate languagetwo amos_mystery_discussion_7005e4ad:
    ...
    ian "Ah, preocupante, mas como todas as coisas deste universo, provavelmente há uma boa explicação."
...
translate languagetwo amos_mystery_discussion_697c1585:
    ...
    lb "Você nunca pode saber a verdade sem ter o contexto ao redor."
...
translate languagetwo amos_mystery_discussion_68deca84:
    ...
    ian "Claro. Deixe-me reunir minhas energias cranianas."
...
translate languagetwo amos_mystery_discussion_1ba95be9:
    ...
    ian "Amos faz parte de algum tipo de culto sexual de luta livre. Eles lutam por esporte e sexo."
...
translate languagetwo amos_mystery_discussion_9c1100a5:
    ...
    ian "Ocasionalmente, quando um deles morre devido a hemorragia interna, eles sacrificam a vítima a Osíris, o deus egípcio da morte."
...
translate languagetwo amos_mystery_discussion_52c36b1c:
    ...
    ian "Veja bem, eu estava saindo do Museu de História Natural. Tenho me interessado por atividades mais intelectuais desde o meu despertar."
...
translate languagetwo amos_cycling_2_3a55ea00:
    ...
    thought "É cedo demais no relacionamento para simplesmente aparecer assim?"

# game/script_amos.rpy:3359
translate languagetwo amos_cycling_2_309757af:

    # thought "Am I crowding him?"
    thought "Estou sufocando ele?"
...
translate languagetwo amos_cycling_2_32694e81:
    ...
    thought "É realmente da minha conta?"
...
translate languagetwo amos_cycling_2_d5e362ad:
    ...
    cyclist2_off "Com licença, querido."
...
translate languagetwo amos_cycling_2_bb065309:
    ...
    cyclist2_off "Mas você está pensando EM VOZ ALTA."
...
translate languagetwo amos_cycling_2_8dbbad29:
    ...
    "Com uma mão segurando a bicicleta, ela usa a outra para tirar um cantil do bolso da jaqueta e desrosquear a tampa."

# game/script_amos.rpy:3384
translate languagetwo amos_cycling_2_5c6cead0:

    # cyclist2_off "Brandy. It'll calm you right down."
    cyclist2_off "Conhaque. Vai te acalmar rapidinho."
...
translate languagetwo amos_cycling_2_dac9d67e:
    ...
    mside "Obrigado, mas não sou muito de beber em cantil."
...
translate languagetwo amos_cycling_2_8109237b:
    ...
    thought "Tudo bem. Isso pode realmente ajudar."
...
translate languagetwo amos_cycling_2_c8313258:
    ...
    "Você pega o cantil e toma um gole generoso."
...
translate languagetwo amos_cycling_2_2fe3e1c1:
    ...
    cyclist2_off "O prazer é meu. E querido."
...
translate languagetwo amos_cycling_2_0f0ca3c7:
    ...
    cyclist2_off "Você é um jovem muito bonito, mas parece bastante INEXPERIENTE."
...
translate languagetwo amos_cycling_2_1fbaadd0:
    ...
    "Ela pedala para longe, quase batendo na lateral de um caminhão de lixo."
...
translate languagetwo amos_confront_3036279a:
    ...
    "Amos abre a porta assim que você bate."
...
translate languagetwo amos_confront_c8ac702a:
    ...
    amos "Eu não estava esperando você. Teria arrumado um pouco se soubesse. Por favor, entre."
...
translate languagetwo amos_confront_b709fba4:
    ...
    mside "Eu vi aqueles homens aqui outro dia."
...
translate languagetwo amos_confront_5141bb8b:
    ...
    amos "Não quero mais continuar essa discussão."
...
translate languagetwo amos_confront_596b2e16:
    ...
    "Sempre um cavalheiro, ele joga sua bicicleta na caçamba da caminhonete e te leva para casa."
...
translate languagetwo amos_confront_24a4b7b5:
    ...
    "Você nota um baú de madeira trancado ao lado do sofá de dois lugares."
...
translate languagetwo amos_confess_9eab9b23:
    ...
    mside "Isso é bem legal. Luta livre parece uma diversão limpa e inocente."
...
translate languagetwo amos_confess_dd951e3d:
    ...
    amos "Bem, não é exatamente só luta livre. As coisas também ficam um pouco, bem, sexuais às vezes."
...
translate languagetwo amos_confess_19ad2aca:
    ...
    mside "Então você luta com outros caras e depois transa com eles?"
...
translate languagetwo amos_look_chest_6ae758da:
    ...
    "Dentro há toneladas de fotografias, um livro, alguns DVDs, dois recortes de jornal e uma máscara de lutador mexicano."
...
translate languagetwo amos_look_chest_10cc975c:
    ...
    "Alguns parecem estar fazendo as duas coisas ao mesmo tempo."
...
translate languagetwo amos_look_chest_93bb115d:
    ...
    amos "Acho melhor você ir embora agora!"
...
translate languagetwo amos_apology_708fa1b3:
    ...
    amos "Isso é uma coisa estúpida de se dizer. Saia."
...
translate languagetwo amos_apology_7f7b5055:
    ...
    amos "Sim, eu admito. Eu gosto de luta livre e sexo."
...
translate languagetwo amos_apology_17871f59:
    ...
    mside "Acho que é um pouco estranho."
...
translate languagetwo amos_apology_ead93631:
    ...
    amos "Você não é um idiota. No geral, muito imaturo. Não estou nada feliz com a maneira como você se comportou."

# game/script_amos.rpy:3633
translate languagetwo amos_apology_b17bb242:

    # mside "I'm sorry. Really, I mean it."
    mside "Sinto muito. Sério, é verdade."
...
translate languagetwo amos_after_confess_82df69c6:
    ...
    amos "Essa não é a reação que eu esperava de você, mas é certamente maravilhoso ouvir isso."
...
translate languagetwo amos_after_confess_ef549b5b:
    ...
    amos "Absolutamente correto. É como chocolate e manteiga de amendoim."
...
translate languagetwo amos_after_confess_fae1041f:
    ...
    amos "Ter um macaco pode {i}parecer{/i} divertido, mas ouvi dizer que eles têm péssimos modos."
...
translate languagetwo amos_after_confess_88ccb77c:
    ...
    amos "Bem, suponho que possa parecer um pouco desconcertante."
...
translate languagetwo amos_after_confess_c77efe1f:
    ...
    amos "Desculpe. Só estou brincando."
...
translate languagetwo amos_after_confess_5a315e31:
    ...
    amos "Sinto muito que você se sinta assim. Mas eu entendo."
...
translate languagetwo amos_after_confess_4d170c1f:
    ...
    mside "Seu sacrifício anual a Osíris?"
...
translate languagetwo amos_after_confess_99b77e8f:
    ...
    amos "Gregor. Ele ainda está com raiva por eu tê-lo superado naquela leitura de poesia."
...
translate languagetwo amos_after_confess_ecc67758:
    ...
    amos "Ele me desafiou para uma luta amanhã à tarde."
...
translate languagetwo amos_after_confess_3423dacb:
    ...
    amos "Obrigado pelo seu apoio, [m]. Farei o meu melhor."
...
translate languagetwo amos_loses_5136dd7f:
    ...
    "Você recebe uma mensagem assim que caminha para casa depois da sua última aula."
...
translate languagetwo amos_loses_da806143:
    ...
    mside "Olha, como eu saio desse enxame?!"
...
translate languagetwo amos_loses_7d7cbc2b:
    ...
    mside "Bem, foi um prazer te conhecer, mas acho que vou virar aqui."
...
translate languagetwo amos_loses_56e54433:
    ...
    "Mas, como em qualquer grupo, os sentimentos mais extremos reverberam mais alto."
...
translate languagetwo amos_loses_eaf82aa1:
    ...
    mside "EU SOU [m] [lastname]! EU NÃO VOU DESVIAR! EU NÃO VOU PARAR! EU SOU A MASSA CRÍTICA DE UM HOMEM SÓ!"
...
translate languagetwo amos_loses_ec79adf7:
    ...
    "Vivas dos outros ciclistas em fuga respondem à sua proclamação."
...
translate languagetwo amos_after_gregor_295feaec:
    ...
    "Você chega à casa de Amos. A porta está destrancada. Você entra."
...
translate languagetwo amos_after_gregor_723e3f33:
    ...
    amos "Temos que entender nossas limitações e ouvir as nuances—as notas suaves de nossas vidas que nos guiam pelos caminhos certos."

# game/script_amos.rpy:3920
translate languagetwo amos_after_gregor_9a4991f1:

    # amos "Hmmm. Anything?"
    amos "Hmmm. Qualquer coisa?"
...
translate languagetwo amos_after_gregor_40ea1c9c:
    ...
    amos "Você realmente quer dizer isso? Porque acabei de ter uma epifania."
...
translate languagetwo amos_after_gregor_227ea778:
    ...
    mside "{i}Um homem não pode se curvar ao pior, ao menor ou inferior e chamar isso de sabedoria.{/i}"
...
translate languagetwo amos_after_gregor_8e02eeec:
    ...
    mside "Especialmente quando é apenas uma racionalização de merda!"
...
translate languagetwo amos_after_gregor_109319ca:
    ...
    amos "O que lhe faltar em força e treinamento, você compensará em velocidade, vigor e, com minha ajuda, astúcia."
...
translate languagetwo amos_after_gregor_84c095a0:
    ...
    thought "Tudo o que você consegue pensar é em ser sensível ao mundo de dor que te espera."
...
translate languagetwo amos_gear_up_16f9ffcf:
    ...
    iside "Aba baba daba doobie doo. Digo estas palavras, certas e verdadeiras. Aba baba daba doobie doo."
...
translate languagetwo amos_gear_up_73411503:
    ...
    mside "Na verdade, sim. É por isso que estou tentando ler este livro e aprender alguns golpes."
...
translate languagetwo amos_gear_up_7b990860:
    ...
    ian "No ensino médio. No último ano. Eu era conhecido como {i}O Rei do Pudim.{/i}"

# game/script_amos.rpy:4067
translate languagetwo amos_gear_up_9c44e2f3:

    # mside "Hmm. Dare I ask why?"
    mside "Hmm. Ouso perguntar por quê?"
...
translate languagetwo amos_gear_up_494b69cb:
    ...
    mside "Por que isso não me surpreende?"
...
translate languagetwo amos_gear_up_14bd4b70:
    ...
    mside "Então você conhece alguns golpes?"
...
translate languagetwo amos_gear_up_59ee766d:
    ...
    mside "Me ensina alguns, então. Estou desesperado."
...
translate languagetwo amos_gear_up_95d07109:
    ...
    ian "Tudo bem. Mas você tem que prometer não usar esse conhecimento para o mal."
...
translate languagetwo amos_gear_up_d4ee52ff:
    ...
    mside "Vou tentar lembrar disso."
...
translate languagetwo amos_wrestling_match_93b833f8:
    ...
    "Dulcinea está deitada em um cobertor e olha para você quando você entra."
...
translate languagetwo amos_wrestling_match_7fd3464d:
    ...
    "Ela abana o rabo e te dá um latido amigável."
...
translate languagetwo amos_wrestling_match_31693c35:
    ...
    "Gregor fala como se você nem estivesse lá."
...
translate languagetwo amos_wrestling_match_65ef1a0c:
    ...
    gregor_poetry "Sua beleza mais longe do que o falcão espia."
...
translate languagetwo amos_wrestling_match_e500018b:
    ...
    "A voz de Ian ecoa na sua cabeça."
...
translate languagetwo amos_wrestling_match_d7aad070:
    ...
    i_off "A parte mais importante da luta livre, cara."
...
translate languagetwo amos_wrestling_match_74bf0845:
    ...
    mside "Um truque tão básico, tão fácil de contornar. Você não conseguiu lidar com meu contra-ataque, assim como vai ser quando estivermos no ringue."

# game/script_amos.rpy:4210
translate languagetwo amos_wrestling_match_fb6d25aa:

    # lb "You must be joking."
    lb "Você deve estar brincando."
...
translate languagetwo amos_wrestling_match_5cf4cb61:
    ...
    amside "Possivelmente porque você não tem convicção."
...
translate languagetwo amos_wrestling_match_c9fe672e:
    ...
    amside "Ok, acho que já chega. Obrigado, [m]."
...
translate languagetwo amos_wrestling_match_9ef5681b:
    ...
    mside "Eu sou um fantasma ou vocês estão tentando fazer algum tipo de jogo psicológico comigo?"
...
translate languagetwo amos_wrestling_match_f00cbbad:
    ...
    mside "Porque eu sei tudo sobre jogos psicológicos e vou te dizer agora que não vai funcionar."
...
translate languagetwo amos_wrestling_match_bc11c1b2:
    ...
    "Ah, mas você liga. Você liga sim."
...
translate languagetwo amos_wrestling_match_487e778a:
    ...
    "Seu rosto fica cada vez mais vermelho enquanto você fala com eles."
...
translate languagetwo amos_wrestling_match_8556e0af:
    ...
    refereeside "Vocês dois guardem isso para o ringue."
...
translate languagetwo amos_wrestling_match_77482822:
    ...
    refereeside "Mas primeiro, vamos rever as regras de combate para que todos entendam."
...
translate languagetwo amos_wrestling_match_ab76aec2:
    ...
    refereeside "Apenas um membro de cada equipe pode estar no ringue por vez."
...
translate languagetwo amos_wrestling_match_7159e503:
    ...
    refereeside "Estamos entendidos?"
...
translate languagetwo amos_wrestling_match_ab03cfff:
    ...
    refereeside "Não haverá mortes hoje."
...
translate languagetwo amos_prefight_044f039f:
    ...
    "Todos se dirigem para a garagem de Amos."
...
translate languagetwo amos_prefight_3fc9177e:
    ...
    mside "Certo. Eu só vou pular e {i}acabar com ele.{/i} Ótimo plano."
...
translate languagetwo amos_announce_fight_438d8589:
    ...
    refereeside "Ouçam, ouçam, senhoras e senhores, esta noite temos uma luta pelo campeonato mundial de duplas."
...
translate languagetwo amos_announce_fight_d07128ba:
    ...
    markall "Como ele sabia meu peso? Isso está me assustando!"
...
translate languagetwo amos_announce_fight_59b89059:
    ...
    refereeside "E {i}neste{/i} canto, pesando um total de 233 quilos, vestindo branco valente, temos Gregor e Dante!"
...
translate languagetwo amos_wrestles_gregor_326fc1b3:
    ...
    "Amos e Gregor se aproximam do meio do campo de batalha."
...
translate languagetwo amos_wrestles_gregor_af4b3b65:
    ...
    refereeside "Vamos ter uma luta boa e limpa. Eu nem queria estar aqui, então não me façam arrepender de ter vindo. Entendido?"
...
translate languagetwo amos_wrestles_gregor_f6cf5ed7:
    ...
    gregor_poetry "E levar uma vida de aflição, mas não abandonar"
...
translate languagetwo amos_wrestles_gregor_bed33fd2:
    ...
    gregor_poetry "Sua condenação futura que é apenas despertar."
...
translate languagetwo amos_wrestles_gregor_0b2935ea:
    ...
    amos "As palavras sempre dançarão nas mãos de um mestre. Nem todas as palavras criam asas, no entanto."
...
translate languagetwo amos_wrestles_gregor_07c30f22:
    ...
    gregor "A beleza se justifica. O amor se justifica. A perfeição busca a si mesma e justifica todas as coisas."
...
translate languagetwo amos_wrestles_gregor_0f7bdcbd:
    ...
    amos_poetry "Eu juro que a terra certamente será completa para ele ou ela que for completo!"
...
translate languagetwo amos_wrestles_gregor_8a63a97e:
    ...
    amos_poetry "Eu juro que a terra permanece irregular e quebrada apenas para ele ou ela que permanece irregular e quebrado!"
...
translate languagetwo amos_wrestles_gregor_147fdd5b:
    ...
    amos_poetry "Eu juro que não há grandeza ou poder que não emule os da terra!"
...
translate languagetwo amos_wrestles_gregor_1fc52b4b:
    ...
    amos_poetry "Eu juro que começo a ver o amor com espasmos mais doces do que aquele que responde ao amor!"
...
translate languagetwo amos_wrestles_gregor_47095595:
    ...
    amos_poetry "Eu juro que vejo o que é melhor do que contar o melhor;"
...
translate languagetwo amos_wrestles_gregor_a59bbe12:
    ...
    amos_poetry "É sempre deixar o melhor por dizer."
...
translate languagetwo amos_wrestles_gregor_c948987b:
    ...
    "Os homens entrelaçam os braços, testando a força um do outro. Nenhum com vantagem aparente, de pé, braços entrelaçados, empurrando com toda força um contra o outro."
...
translate languagetwo amos_wrestles_gregor_03b77fba:
    ...
    gregor "Sentindo-se arrogante? Isso é uma mudança. Não combina nada com você."
...
translate languagetwo amos_wrestles_gregor_eef236b9:
    ...
    amside "No fundo, você é um homem muito simples. Nada além de bravata, e sem o reconhecimento dos outros, você não possui nada."
...
translate languagetwo amos_wrestles_gregor_f2f2fbac:
    ...
    amside "No momento em que você é considerado menor, você se torna menor. Como eu te vejo como nada, você se torna nada."

# game/script_amos.rpy:4518
translate languagetwo amos_wrestles_gregor_97f04e43:

    # gregor "You have no idea."
    gregor "Você não faz ideia."
...
translate languagetwo amos_wrestles_gregor_95dda093:
    ...
    gregorside "É divertido que você pense que seus jogos mentais estão funcionando."
...
translate languagetwo amos_wrestles_gregor_d25b6992:
    ...
    amos "Vou te dar essa única chance de desistir antes de te humilhar ainda mais."

# game/script_amos.rpy:4543
translate languagetwo amos_wrestles_gregor_43e52037:

    # gregorside "Alright. I submit."
    gregorside "Tudo bem. Eu desisto."
...
translate languagetwo amos_wrestles_gregor_a02de707:
    ...
    "O estrondo trovejante quando seu corpo imenso aterrissa ecoa pela garagem."
...
translate languagetwo amos_wrestles_gregor_4a41eb80:
    ...
    amside "Desista agora. O dia está perdido e você não tem nada a ganhar com essa farsa."
...
translate languagetwo amos_wrestles_gregor_17f91507:
    ...
    "Gregor, ainda deitado imóvel no tatame, não diz nada. Dante se abaixa e toca a mão dele."
...
translate languagetwo amos_wrestles_gregor_41f27a29:
    ...
    "Amos simplesmente dá um passo para o lado. Dante cai no chão."
...
translate languagetwo amos_wrestles_gregor_a290de68:
    ...
    "Enquanto você discute com Willy e Amos cuida de Gregor, Dante se recuperou e está de volta ao ataque."
...
translate languagetwo amos_wrestles_gregor_2c6fc5f8:
    ...
    amside "Este homem pode estar ferido. Você poderia parar com isso, por favor?"
...
translate languagetwo amos_wrestles_gregor_2b2d2f9b:
    ...
    "Gregor, sentindo que o momento é certo, volta à vida. Ele agarra o tornozelo de Amos e puxa com força."
...
translate languagetwo amos_wrestles_gregor_0d8023cb:
    ...
    mside "VIRE-SE! ELES ESTÃO TRAPACEANDO! OLHE, DROGA!"
...
translate languagetwo amos_wrestles_gregor_2729b34b:
    ...
    "Você luta para passar por ele, mas ele não se move."
...
translate languagetwo amos_wrestles_gregor_fb14e4a4:
    ...
    "Você não consegue acreditar no que vê, na injustiça disso, na rápida reviravolta dos acontecimentos, mas contido pelo árbitro, você é incapaz de fazer qualquer coisa."
...
translate languagetwo amos_wrestle_win_c127de75:
    ...
    "Vocês dois cobrem e imobilizam seus oponentes simultaneamente."
...
translate languagetwo amos_wrestle_win_e4e728d6:
    ...
    amside "Deus te ajude se algo tivesse acontecido com ela."
...
translate languagetwo amos_bedroom_wrestle_17774cca:
    ...
    amos "Aquilo foi realmente selvagem."
...
translate languagetwo amos_bedroom_wrestle_07db8c5f:
    ...
    mside "Só estou feliz que a luta acabou."
...
translate languagetwo amos_bedroom_wrestle_4e27dbcc:
    ...
    "Ele roça sua bochecha com as costas da outra mão."
...
translate languagetwo amos_bedroom_wrestle_7008d35c:
    ...
    amside "Em você. Seu rosto. Como você está maravilhoso agora."
...
translate languagetwo amos_bedroom_wrestle_4f8f5899:
    ...
    "O beijo faz o resto do mundo, seu corpo, o cansaço e a dor derreterem, revelando a única verdade que você sempre precisou."
...
translate languagetwo amos_bedroom_wrestle_322bf6fa:
    ...
    "Você luta, tentando tirá-lo de cima de você. "
...
translate languagetwo amos_bedroom_wrestle_c5e04434:
    ...
    "O suor do seu corpo torna o aperto dele mais escorregadio e suave. Um arrepio violento percorre seu corpo."
...
translate languagetwo amos_bedroom_wrestle_d270f84c:
    ...
    "Você tenta se afastar, mas é impotente sob a força de Amos."
...
translate languagetwo amos_bedroom_wrestle_13f0e5cb:
    ...
    "Sua resistência derrete enquanto você sente a si mesmo se esticando ao redor dele."
...
translate languagetwo amos_bedroom_wrestle_57117cd1:
    ...
    "Ele passa a mão para cima e para baixo no comprimento do seu pau. Descendo pelo seu corpo, lambendo e beijando você até sua mente ficar em branco."
...
translate languagetwo amos_bedroom_wrestle_6ab08b56:
    ...
    "Ele grunhe no seu ouvido enquanto agarra seu ombro. A cama estremece."
...
translate languagetwo amos_bedroom_wrestle_1b828a2e:
    ...
    "Sêmen jorra do seu pau inchado. Ele acaricia com força, ordenhando até a última gota possível."
...
translate languagetwo amos_bedroom_wrestle_178ca64b:
    ...
    amside "Hmm. Talvez tenha sido um empate."
...
translate languagetwo amos_bedroom_wrestle_9373724a:
    ...
    mside "Espeeeera! Merda! Acho que torci alguma coisa!"
...
translate languagetwo amos_bedroom_wrestle_8a519522:
    ...
    amside "Eu te machuquei? Você está bem?"
...
translate languagetwo amos_bedroom_wrestle_159308ea:
    ...
    "Mais de surpresa do que qualquer outra coisa, ele cai para trás na cama, debaixo do seu corpo."
...
translate languagetwo amos_bedroom_wrestle_2208ed7e:
    ...
    amside "Isso é jogo sujo! Juiz! Juiz!"
...
translate languagetwo amos_bedroom_wrestle_76fd240c:
    ...
    "Você desliza para dentro do cu apertado dele, empurrando mais fundo, impossivelmente mais fundo, seu membro enterrado, o calor das nádegas dele contra suas coxas."
...
translate languagetwo amos_bedroom_wrestle_fa5cccd6:
    ...
    "Sólido como uma barra de aço, o pau quente dele pulsa na sua mão."
...
translate languagetwo amos_bedroom_wrestle_bb2d2f48:
    ...
    "Você se solta como um louco, fodendo implacavelmente, sem remorso, olhos fechados, a sensação deliciosa é tudo o que você consegue compreender."
...
translate languagetwo amos_bedroom_wrestle_4e1cb1e5:
    ...
    "Você bate e bate e bate mais, Amos grunhindo a cada empurrão."
...
translate languagetwo amos_bedroom_wrestle_50b18c2d:
    ...
    "Sentindo-se aproximar do clímax novamente, você não consegue e não quer parar."
...
translate languagetwo amos_bedroom_wrestle_4448f749:
    ...
    "Ele grita enquanto dispara sua carga quente. Ela respinga na sua barriga, nas suas coxas, a umidade morna te excitando."

# game/script_amos.rpy:4920
translate languagetwo amos_bedroom_wrestle_844a2354:

    # "The sight of it sets you off."
    "A visão disso te faz disparar."
...
translate languagetwo amos_bedroom_wrestle_e65375e5:
    ...
    mside "Parece que eu ganhei afinal."
...
translate languagetwo amos_wrestle_lose_34b249a2:
    ...
    "Finalmente lhe ocorre parar de resistir a Willy."
...
translate languagetwo amos_wrestle_lose_36478906:
    ...
    gregorside_poetry "Com triunfo sobre aquele duque de mente maligna!"
...
translate languagetwo amos_wrestle_lose_5dd932f6:
    ...
    gregorside_poetry "Ele sentirá o que é ter a mão"
...
translate languagetwo amos_wrestle_lose_fe957cce:
    ...
    gregorside_poetry "De um homem se afogando, em sua garganta odiosa."
...
translate languagetwo amos_wrestle_lose_9f34599a:
    ...
    amside "É da província dos ímpios fazer coisas ímpias, e eles devem."
...
translate languagetwo amos_wrestle_lose_90d18236:
    ...
    "Você vê um olhar animado no rosto de Willy."
...
translate languagetwo amos_wrestle_lose_d74a984a:
    ...
    amside "Então, qual é o nosso destino?"
...
translate languagetwo amos_wrestle_lose_5e3e608f:
    ...
    gregorside "Vocês descobrirão em breve. A antecipação é a melhor parte, no entanto. Não quero privá-los disso."
...
translate languagetwo amos_wrestle_lose_29f3ca73:
    ...
    danteside "Exceto que o espaguete vai ser branco e cremoso."
...
translate languagetwo amos_wrestle_lose_f97b8bfe:
    ...
    danteside "Não nos apresse, cara. Isso não é erótico. Construir o desejo é a essência de todo erotismo."
...
translate languagetwo amos_wrestle_lose_45d27d9a:
    ...
    gregorside "Sério? Eu diria que agressão, poder e subjugação são as coisas importantes."
...
translate languagetwo amos_wrestle_lose_b74ff81e:
    ...
    amside "Suponho que não. Um ponto decente seu, pela primeira vez."
...
translate languagetwo amos_wrestle_lose_99b5f59e:
    ...
    mside "Espere! Todas essas preliminares para gozar na gente?"
...
translate languagetwo amos_wrestle_lose_f8a8763b:
    ...
    refereeside "Você é uma boa cadelinha. Vai servir bem aos meus propósitos, garoto."
...
translate languagetwo amos_wrestle_lose_3102bce1:
    ...
    "Você o encara, silencioso e desafiador."
...
translate languagetwo amos_wrestle_lose_4811ce9b:
    ...
    "Gregor, Dante e Willy começam a se despir, exibindo seus corpos."
...
translate languagetwo amos_wrestle_lose_7a1df739:
    ...
    "Eles começam a acariciar seus paus enquanto circulam ao seu redor, lentos, deliberados, como leões antes do abate."
...
translate languagetwo amos_wrestle_lose_3d971e73:
    ...
    thought "Estou seriamente impressionado."
...
translate languagetwo amos_wrestle_lose_84806659:
    ...
    "Talvez raiva, talvez fúria, mas não parece agradável. As veias em sua pele e rosto saltando."
...
translate languagetwo amos_wrestle_lose_102e9008:
    ...
    timestamp "Quarenta e cinco minutos depois..."
...
translate languagetwo amos_wrestle_lose_32dbe374:
    ...
    "Willy, no entanto, parece perdido para o mundo exterior."
...
translate languagetwo amos_wrestle_lose_12fab119:
    ...
    "Se você pudesse rastejar para as profundezas da mente de Willy, veria um mundo que não reconheceria. E agora, Willy estaria de pé nas costas de um pônei de pelúcia em tamanho real."
...
translate languagetwo amos_wrestle_lose_1b07f45a:
    ...
    "Willy olha com desejo para cada um deles enquanto acaricia seu pau."
...
translate languagetwo amos_wrestle_lose_088f0d3c:
    ...
    "A luta de Willy é a luta de todos os homens—gozar antes que o pônei vire cinzas."
...
translate languagetwo amos_wrestle_lose_790023a5:
    ...
    refereeside "EU SOU O CARA, PORRA!!!!"
...
translate languagetwo amos_wrestle_weird_01e9f046:
    ...
    "Você empurra Willy com tudo o que tem, mas ele parece preparado."
...
translate languagetwo amos_wrestle_weird_e22939ef:
    ...
    mside "Vá buscar ajuda, garota! Corra o mais rápido que puder!"
...
translate languagetwo amos_wrestle_weird_85568e5a:
    ...
    refereeside "Como você quer, rapaz? Mole ou duro?"
...
translate languagetwo amos_wrestle_weird_91f4e44f:
    ...
    gregorside "Deixa pra lá. Continue batendo. Você está servindo ao seu propósito."
...
translate languagetwo amos_wrestle_weird_9ab7d0d1:
    ...
    mside "Hesito em admitir isso, mas na verdade estou me perguntando o que {i}O Rei do Pudim{/i} faria nessa situação."
...
translate languagetwo amos_wrestle_weird_e94c8349:
    ...
    "Você ouve a voz de Ian atrás de você. Você olha."
...
translate languagetwo amos_wrestle_weird_f5c5563a:
    ...
    mside "Uau. Sua velocidade ficou muito boa. Estou impressionado."
...
translate languagetwo amos_wrestle_weird_67a9b806:
    ...
    mside "{size=-10}Na verdade, o termo correto é '{i}nunchaku.{/i}'{/size}"
...
translate languagetwo amos_wrestle_weird_ab2c42e6:
    ...
    gregorside "É melhor você não errar."
...
translate languagetwo amos_wrestle_weird_927a3869:
    ...
    "Incapaz de se mover ou resistir, Gregor desliza rapidamente para a inconsciência à medida que o suprimento de ar para seu cérebro se esgota."
...
translate languagetwo amos_wrestle_weird_bb416b02:
    ...
    mside "Ok. Vamos fazer isso. Não acho que terei outra chance de ver isso pelo resto da minha vida."

# game/script_amos.rpy:5291
translate languagetwo amos_wrestle_weird_cc076019:

    # timestamp "30 Minutes later..."
    timestamp "30 Minutos depois..."
...
translate languagetwo amos_wrestle_weird_bf13d161:
    ...
    gregorside "Você não pode estar falando sério sobre isso."
...
translate languagetwo amos_wrestle_weird_e9db943a:
    ...
    iside "Vocês deveriam realmente abraçar seus papéis e aproveitar a experiência."
...
translate languagetwo amos_wrestle_weird_bde6244b:
    ...
    "Dante relutantemente pega o lubrificante e prepara as partes necessárias."
...
translate languagetwo amos_wrestle_weird_a679a98e:
    ...
    "Você não consegue acreditar no que vê. Tão bizarro, mas maravilhoso. Você nunca sonhou com algo tão estranho."
...
translate languagetwo amos_wrestle_weird_0bd09cd4:
    ...
    "Talvez você tenha um fetiche por flora, ou talvez seja um bastardo incrivelmente doente."
...
translate languagetwo amos_end_20bd01a1:
    ...
    timestamp "NAQUELE FIM DE SEMANA..."
...
translate languagetwo amos_end_c1c7c23a:
    ...
    mside "Cheira a história aqui dentro."
...
translate languagetwo amos_end_2cd984ba:
    ...
    mside "Acho que podemos mostrar a elas uma coisa ou duas."
...
translate languagetwo amos_end_e2a549de:
    ...
    "Amos abre a garrafa de vinho na mesa do hotel."
...
translate languagetwo amos_end_dfa75907:
    ...
    "Ele coloca a mão dele sobre a sua."
...
translate languagetwo amos_end_4d008abc:
    ...
    "O vinho parece bater especialmente rápido e você sente sua mente começar a flutuar e vagar um pouco."
...
translate languagetwo amos_end_92c6c10d:
    ...
    amside "Embora a memória esteja enfraquecendo e eu me preocupe em perder esse sabor em breve."
...
translate languagetwo amos_end_b561e7c2:
    ...
    amside "Eu quero algo completamente diferente."
...
translate languagetwo amos_end_8d1d8685:
    ...
    "Suas roupas parecem encontrar seu próprio caminho para fora de seus corpos enquanto vocês dois submergem sob as cobertas e um no outro."
...
translate languagetwo amos_end_87c81f27:
    ...
    amside "Vamos ficar aqui. Vamos dormir."
...
translate languagetwo amos_end_b198ac80:
    ...
    "Ele segura sua mão debaixo das cobertas e, a partir daí, vocês dois não falam mais nada."
...
translate languagetwo amos_end_0de49801:
    ...
    "Mas olhando um para o outro, felizes no momento, vagam pelos olhos um do outro até que ambos finalmente adormecem."
...
translate languagetwo amos_epilogue_42199833:
    ...
    "Eventualmente, Amos pede para você morar com ele. Mas não em sua pitoresca casa amarela em Orlin."
...
translate languagetwo amos_epilogue_547ce089:
    ...
    "Você rapidamente fica inquieto."
...
translate languagetwo amos_epilogue_4f57582a:
    ...
    "Em dois anos, você está quase no topo do departamento de marketing doméstico de um conglomerado de móveis chinês."
...
translate languagetwo amos_epilogue_d501ce6c:
    ...
    "Vocês dois fazem a coisa típica de se apaixonar / casar / contratar uma barriga de aluguel para ter um bebê. A vida fica chata. Você e seu marido, Rolf, começam a não dar valor um ao outro."
...
translate languagetwo strings:
    ...
    new "Uma taça de Sauvignon Blanc, por favor."

    # script_amos.rpy:18
    old "I'll have a beer."
    new "Vou querer uma cerveja."

    # script_amos.rpy:18
    old "The usual, good sir."
    new "O de sempre, meu bom senhor."
    ...
    new "Suponho que você esteja correto."

    # script_amos.rpy:44
    old "I'm just going to enjoy my drink. Thank you. {i}*Look away*{/i}"
    new "Vou apenas aproveitar minha bebida. Obrigado. {i}*Desviar o olhar*{/i}"

    # script_amos.rpy:123
    old "Ok, you really had me going there. I actually believed you when you said weren't a Rico."
    new "Ok, você realmente me enganou. Eu realmente acreditei quando você disse que não era um Rico."

    # script_amos.rpy:123
    old "Do you wanna just put the roofie in my drink now, or should we wait 'til I'm back at your place?"
    new "Você quer colocar o 'boa noite, Cinderela' na minha bebida agora, ou devemos esperar até eu estar na sua casa?"

    # script_amos.rpy:164
    old "YOU'RE NOT PAYING FOR ANYTHING, ASSHOLE! NOW FUCK OFF."
    new "VOCÊ NÃO VAI PAGAR POR NADA, SEU BABACA! AGORA VAZA."

    # script_amos.rpy:164
    old "If you continue this course of action, it's going to end badly for you. {i}Very badly.{/i}"
    new "Se você continuar com essa atitude, vai acabar mal para você. {i}Muito mal.{/i}"

    # script_amos.rpy:164
    old "Exactly how much money are we talking about here?"
    new "Exatamente de quanto dinheiro estamos falando aqui?"

    # script_amos.rpy:228
    old "People are so superficial, right?"
    new "As pessoas são tão superficiais, né?"

    # script_amos.rpy:228
    old "Well, I don't think you're plain looking."
    new "Bem, eu não acho que você tenha uma aparência comum."
    ...
    new "Você é comum? Não sei como alguém saberia com essa barba. Qual é a dessa coisa com barbas hoje em dia? Já chega."

    # script_amos.rpy:288
    old "{i}Accept the ride.{/i}"
    new "{i}Aceitar a carona.{/i}"

    # script_amos.rpy:288
    old "{i}Politely decline.{/i}"
    new "{i}Recusar educadamente.{/i}"

    # script_amos.rpy:288
    old "Is this some kind of trick? It seems like all I've met are liars and jerks tonight."
    new "Isso é algum tipo de truque? Parece que só encontrei mentirosos e babacas hoje à noite."
    ...
    new "Talvez romântico, talvez um pouco mais do que isso. Sim, sim?"

    # script_amos.rpy:372
    old "Ok, this is gonna sound mean, but romantic? Are you for real? How about just a normal date?"
    new "Ok, isso vai soar malvado, mas romântico? Você está falando sério? Que tal apenas um encontro normal?"

    # script_amos.rpy:372
    old "Actually, I've got this jug of pennies and wanted to sort out all the pre-1982 ones. But it's a huge job. Wanna help?"
    new "Na verdade, tenho esse jarro de moedas e queria separar todas as anteriores a 1982. Mas é um trabalho enorme. Quer ajudar?"

    # script_amos.rpy:372
    old "Sorry, I'm really busy with school these days."
    new "Desculpe, estou muito ocupado com a escola hoje em dia."

    # script_amos.rpy:464
    old "Um heh, okay. *{i}blush{/i}*"
    new "Hum heh, ok. *{i}corar{/i}*"

    # script_amos.rpy:464
    old "He's a guy, I'm a guy, that's all there is to know."
    new "Ele é um cara, eu sou um cara, isso é tudo o que há para saber."

    # script_amos.rpy:464
    old "Penny, don't you have some bugs to fix?"
    new "Penny, você não tem alguns bugs para corrigir?"

    # script_amos.rpy:553
    old "{i}Keep it casual in a t-shirt.{/i}"
    new "{i}Manter casual com uma camiseta.{/i}"

    # script_amos.rpy:553
    old "{i}Dress up for god's sake.{/i}"
    new "{i}Se arrumar, pelo amor de deus.{/i}"

    # script_amos.rpy:647
    old "No fried chicken or fruit roll-ups? What the heck, man?"
    new "Sem frango frito ou rolinhos de frutas? Que diabos, cara?"

    # script_amos.rpy:647
    old "Sounds kind of {i}cheesy{/i}, if you get my drift. Heh."
    new "Soa meio {i}brega{/i} (cheesy - trocadilho com queijo), se é que você me entende. Heh."

    # script_amos.rpy:647
    old "This place is nice and secluded. {i}It's perfect.{/i} *wink wink*"
    new "Este lugar é agradável e isolado. {i}É perfeito.{/i} *pisca pisca*"

    # script_amos.rpy:647
    old "This place is beautiful. It’s so serene."
    new "Este lugar é lindo. É tão sereno."

    # script_amos.rpy:724
    old "LOL. You are so right. Wanna fuck?"
    new "LOL. Você está tão certo. Quer transar?"

    # script_amos.rpy:724
    old "That's a good point."
    new "Esse é um bom ponto."

    # script_amos.rpy:724
    old "Cry me a river, Mary. It's not that bad."
    new "Chore um rio, Mary. Não é tão ruim assim."

    # script_amos.rpy:724
    old "I like the way you talk, big feller."
    new "Eu gosto do jeito que você fala, grandalhão."

    # script_amos.rpy:779
    old "Remove the cattail and pet her."
    new "Remover a taboa e fazer carinho nela."
    ...
    new "Acha que poderíamos colocar o balonista em um menage nas alturas?"

    # script_amos.rpy:853
    old "Roses are red, violets are blue, poetry is corny, and so are you."
    new "Rosas são vermelhas, violetas são azuis, poesia é brega, e você também."

    # script_amos.rpy:853
    old "Whatever. I'm just sad I didn't bring my magnifying glass. There are SO MANY ants here."
    new "Tanto faz. Só estou triste por não ter trazido minha lupa. Tem TANTAS formigas aqui."

    # script_amos.rpy:853
    old "{i}Bite your lip and say nothing{/i}"
    new "{i}Morder o lábio e não dizer nada{/i}"

    # script_amos.rpy:951
    old "Well, actually, I haven't come yet. {i}*Wink*{/i}"
    new "Bem, na verdade, eu ainda não gozei. {i}*Pisca*{/i}"

    # script_amos.rpy:951
    old "Hey, listen. If we toss Mr. Balloon Man over the side, I bet we could sell this thing for 10, 20 grand. What do you say?"
    new "Ei, escuta. Se jogarmos o Sr. Homem do Balão para fora, aposto que poderíamos vender essa coisa por 10, 20 mil. O que me diz?"

    # script_amos.rpy:951
    old "Would you freak out if I started jumping up and down right now?"
    new "Você surtaria se eu começasse a pular para cima e para baixo agora mesmo?"

    # script_amos.rpy:951
    old "I never expected anything like this."
    new "Eu nunca esperei nada assim."

    # script_amos.rpy:1003
    old "Okay. Sounds fun."
    new "Ok. Parece divertido."

    # script_amos.rpy:1003
    old "Poetry? Uh, no, I've got, uh, something else going on."
    new "Poesia? Uh, não, eu tenho, uh, outra coisa para fazer."

    # script_amos.rpy:1175
    old "Yes, Edgy. Help me!"
    new "Sim, Edgy. Me ajude!"
    ...
    new "Espera um segundo. Como você saberia disso?"
    ...
    new "Chamar Ian e Penny para compartilhar sua obra-prima."

    # script_amos.rpy:1277
    old "Keep quiet. This shit's embarrassing."
    new "Ficar quieto. Essa merda é constrangedora."

    # script_amos.rpy:1489
    old "{i}Follow Amos' lead and refuse to clap.{/i}"
    new "{i}Seguir o exemplo de Amos e se recusar a aplaudir.{/i}"

    # script_amos.rpy:1489
    old "{i}Clap politely.{/i}"
    new "{i}Aplaudir educadamente.{/i}"

    # script_amos.rpy:1489
    old "{i}Hiss and boo.{/i}"
    new "{i}Vaiar e chiar.{/i}"

    # script_amos.rpy:1489
    old "{i}Whistle and cheer.{/i}"
    new "{i}Assobiar e torcer.{/i}"

    # script_amos.rpy:1790
    old "Gosh, the words just pop into my head. It's like magic!"
    new "Poxa, as palavras simplesmente surgem na minha cabeça. É como mágica!"

    # script_amos.rpy:1790
    old "I think...being around you has had an effect on me."
    new "Eu acho... estar perto de você teve um efeito em mim."

    # script_amos.rpy:1790
    old "Never mind that. What was your ex talking about earlier? Something about 'beating you in the ring?'"
    new "Esquece isso. Do que seu ex estava falando mais cedo? Algo sobre 'te vencer no ringue?'"

    # script_amos.rpy:1806
    old "You're better than anything I could have imagined."
    new "Você é melhor do que qualquer coisa que eu poderia ter imaginado."
    ...
    new "{i}Contar a ele o que aconteceu entre você e Amos.{/i}"

    # script_amos.rpy:2016
    old "It's none of your business. {i}Usher him out of the apartment.{/i}"
    new "Não é da sua conta. {i}Conduzi-lo para fora do apartamento.{/i}"

    # script_amos.rpy:2016
    old "{i}Lie and tell him everyone in your family died due to a freak ski lift accident.{/i}"
    new "{i}Mentir e dizer a ele que todos na sua família morreram devido a um acidente bizarro em um teleférico de esqui.{/i}"
    ...
    new "Sabe de uma coisa? Isso não vai acontecer. Agora suma daqui antes que eu ligue e te denuncie para o seu gerente."

    # script_amos.rpy:2024
    old "{i}Give him a tip.{/i}"
    new "{i}Dar uma gorjeta a ele.{/i}"

    # script_amos.rpy:2153
    old "I'm just going to thank Amos in person."
    new "Vou apenas agradecer a Amos pessoalmente."

    # script_amos.rpy:2153
    old "All right. You're crazy but I'll send him the shrub."
    new "Tudo bem. Você é louco, mas vou enviar o arbusto para ele."

    # script_amos.rpy:2234
    old "Cycle aggressively."
    new "Pedalar agressivamente."
    ...
    old "Continue on."
    new "Continue em frente."

    # script_amos.rpy:2302
    old "Do the sensible thing and backtrack to where you started."
    new "Faça a coisa sensata e volte para onde você começou."

    # script_amos.rpy:2308
    old "Keep going anyway."
    new "Continue indo de qualquer maneira."
    ...
    new "Esmague o medo e vá para frente."

    # script_amos.rpy:2357
    old "Fuck it. Keep moving forward."
    new "Foda-se. Continue seguindo em frente."
    ...
    new "Levante-se e sacuda a poeira."

    # script_amos.rpy:2449
    old "Grin and bear it and keep walking forward."
    new "Sorria, aguente firme e continue caminhando para frente."

    # script_amos.rpy:2455
    old "Limp on."
    new "Continue mancando."
    ...
    new "Rasteje, droga, rasteje!"

    # script_amos.rpy:2476
    old "Uuurrrrrrggghhh. Must. Keep. Going."
    new "Uuurrrrrrggghhh. Devo. Continuar. Indo."
    ...
    old "Take the cash."
    new "Pegar o dinheiro."

    # script_amos.rpy:2499
    old "Leave it and be happy that you've found your way back."
    new "Deixar lá e ficar feliz por ter encontrado o caminho de volta."

    # script_amos.rpy:2642
    old "Fine. {i}Tip the man.{/i}"
    new "Tudo bem. {i}Dê uma gorjeta ao homem.{/i}"
    ...
    new "{i}Jogar moedas aos pés dele.{/i}"

    # script_amos.rpy:2734
    old "{i}Text Amos yes.{/i}"
    new "{i}Enviar mensagem para Amos dizendo sim.{/i}"

    # script_amos.rpy:2734
    old "{i}Text Amos no.{/i}"
    new "{i}Enviar mensagem para Amos dizendo não.{/i}"
    ...
    new "{i}Colocar a venda.{/i}"

    # script_amos.rpy:2791
    old "No way, Jose. I'm not getting murdered tonight. Maybe some other time."
    new "De jeito nenhum, Zé. Não vou ser assassinado hoje à noite. Talvez em outra ocasião."
    ...
    new "Radical. Acha que eles têm shuffleboard? Porque eu tô querendo jogar há um tempo."

    # script_amos.rpy:2833
    old "How romantic! I can't wait."
    new "Que romântico! Mal posso esperar."

    # script_amos.rpy:2833
    old "How... {i}quaint{/i}."
    new "Que... {i}pitoresco{/i}."

    # script_amos.rpy:2833
    old "Niiice. I've never banged on a boat before."
    new "Leeegal. Eu nunca transei em um barco antes."

    # script_amos.rpy:2908
    old "That looks amazing."
    new "Isso parece incrível."

    # script_amos.rpy:2908
    old "Chicory-dickory, doc."
    new "Chicória-dicória, doc."

    # script_amos.rpy:2958
    old "Oh wow! Are all these for me?"
    new "Oh uau! São todos para mim?"

    # script_amos.rpy:2958
    old "{i}Take the candied rose petal champagne gelato.{/i}"
    new "{i}Pegar o gelato de champanhe com pétalas de rosa cristalizadas.{/i}"

    # script_amos.rpy:2958
    old "I'm fine, and I don't think my friend here needs any of this."
    new "Estou bem, e não acho que meu amigo aqui precise de nada disso."

    # script_amos.rpy:2958
    old "Maybe I should be on that tray. *Wink Wink*"
    new "Talvez eu devesse estar nessa bandeja. *Pisca Pisca*"

    # script_amos.rpy:2996
    old "So that cat. Is that supposed to represent love?"
    new "Então aquele gato. É suposto representar o amor?"

    # script_amos.rpy:2996
    old "So like, even though he's gay, he's now looking for wet pussy? Like she's turned him straight. {i}Come on now.{/i}"
    new "Então, tipo, mesmo ele sendo gay, agora ele está procurando uma buceta molhada (gatinho molhado)? Como se ela o tivesse tornado hétero. {i}Fala sério.{/i}"

    # script_amos.rpy:2996
    old "Why a cat? Why not a turtle?"
    new "Por que um gato? Por que não uma tartaruga?"

    # script_amos.rpy:3024
    old "What a great movie. I loved it."
    new "Que ótimo filme. Eu amei."

    # script_amos.rpy:3024
    old "I thought it was all right."
    new "Achei que foi legal."

    # script_amos.rpy:3024
    old "Eh, not really my cup of tea."
    new "Eh, não é muito minha praia."

    # script_amos.rpy:3024
    old "I was hoping for some guns. Explosions. At least a high-speed car chase! DEATH! VIOLENCE!"
    new "Eu estava esperando por algumas armas. Explosões. Pelo menos uma perseguição de carro em alta velocidade! MORTE! VIOLÊNCIA!"

    # script_amos.rpy:3117
    old "I've got big plans. I'm pretty ambitious."
    new "Tenho grandes planos. Sou bastante ambicioso."

    # script_amos.rpy:3117
    old "I'm still thinking about it."
    new "Ainda estou pensando sobre isso."

    # script_amos.rpy:3117
    old "This might sound unusual, but I don't have any right now. I'm just gonna see where things take me."
    new "Isso pode soar incomum, mas não tenho nenhum agora. Vou apenas ver onde as coisas me levam."

    # script_amos.rpy:3117
    old "I don't know. And I'm pretty anxious about it."
    new "Eu não sei. E estou muito ansioso com isso."

    # script_amos.rpy:3170
    old "Maybe you could, you know, put on a wizard hat. "
    new "Talvez você pudesse, sabe, colocar um chapéu de mago. "

    # script_amos.rpy:3170
    old "We're about to bone, aren't we?"
    new "Nós estamos prestes a transar, não estamos?"

    # script_amos.rpy:3170
    old "Just answer the freaking question."
    new "Apenas responda a maldita pergunta."

    # script_amos.rpy:3170
    old "{i}Say nothing.{/i}"
    new "{i}Não dizer nada.{/i}"

    # script_amos.rpy:3392
    old "Hmmm. Well, you've got a point. It's a little off the wall, but it {i}is{/i} a point."
    new "Hmmm. Bem, você tem um ponto. É um pouco fora do comum, mas {i}é{/i} um ponto."

    # script_amos.rpy:3392
    old "You can’t be serious."
    new "Você não pode estar falando sério."
    ...
    new "Deixar quieto e tentar se acalmar."

    # script_amos.rpy:3578
    old "{i}Apologize.{/i} "
    new "{i}Pedir desculpas.{/i} "
    ...
    new "Como um serial killer com uma família amorosa?"
    ...
    new "Na verdade, soa incrivelmente sexy. Tô dentro."

    # script_amos.rpy:3643
    old "I'm not here to judge. I care about you and can accept your interests, even if they're a little strange to me."
    new "Não estou aqui para julgar. Eu me importo com você e posso aceitar seus interesses, mesmo que sejam um pouco estranhos para mim."

    # script_amos.rpy:3643
    old "I {i}knew{/i} you were perverted, you big old {i}freak{/i}, you!"
    new "Eu {i}sabia{/i} que você era pervertido, seu grande {i}esquisitão{/i}!"

    # script_amos.rpy:3643
    old "I need to tell you something, too. I actually love canned meat. {size=-10}Don't hate me.{/size}"
    new "Eu preciso te contar uma coisa também. Na verdade, eu amo carne enlatada. {size=-10}Não me odeie.{/size}"

    # script_amos.rpy:3643
    old "I don't think I can handle this."
    new "Eu não acho que consigo lidar com isso."

    # script_amos.rpy:3725
    old "In that case, kick his ass for me."
    new "Nesse caso, chuta a bunda dele por mim."

    # script_amos.rpy:3725
    old "You're wrestling with your ex? Um, I'm not sure how I feel about that."
    new "Você vai lutar com seu ex? Hum, não tenho certeza de como me sinto sobre isso."

    # script_amos.rpy:3732
    old "Then I hope you decimate him for me."
    new "Então espero que você dizime ele por mim."

    # script_amos.rpy:3732
    old "I don't think I'm okay with this."
    new "Acho que não estou bem com isso."

    # script_amos.rpy:3752
    old "It was nice meeting you, Amos. I had a good time."
    new "Foi bom te conhecer, Amos. Eu me diverti."

    # script_amos.rpy:3752
    old "See ya, ya big freak."
    new "Até mais, seu grande esquisito."

    # script_amos.rpy:3879
    old "How could you lose to a {i}Keats{/i} guy?"
    new "Como você pôde perder para um cara fã de {i}Keats{/i}?"

    # script_amos.rpy:3879
    old "That sonofabitch. I will end him!"
    new "Aquele filho da mãe. Vou acabar com ele!"

    # script_amos.rpy:3879
    old "Are you hurt badly?"
    new "Você se machucou muito?"
    ...
    new "Amos, eu te ajudarei como puder. Se precisar de apoio moral, motivação ou qualquer coisa, estarei lá."

    # script_amos.rpy:3916
    old "{i}Say something inspirational.{/i}"
    new "{i}Dizer algo inspirador.{/i}"

    # script_amos.rpy:4196
    old "{i}Talk mild trash.{/i}"
    new "{i}Provocar de leve.{/i}"

    # script_amos.rpy:4196
    old "{i}Talk serious trash.{/i}"
    new "{i}Provocar pesado.{/i}"

    # script_amos.rpy:4196
    old "{i}Point out how ignoring you is an immature and ineffective manipulation tactic.{/i}"
    new "{i}Apontar como ignorar você é uma tática de manipulação imatura e ineficaz.{/i}"

    # script_amos.rpy:4731
    old "Can we just take a breather? I just want to chill with you."
    new "Podemos dar um tempo? Só quero relaxar com você."
    ...
    new "{i}Obedientemente fazer o que ele pede.{/i}"

    # script_amos.rpy:5073
    old "{i}Growl like an animal and show him your teeth.{/i}"
    new "{i}Rosnar como um animal e mostrar os dentes.{/i}"
